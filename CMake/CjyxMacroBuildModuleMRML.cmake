...
macro(CjyxMacroBuildModuleMRML)
  set(options
    DISABLE_WRAP_PYTHON
    NO_INSTALL
    )
  ...
  if(MODULEMRML_UNPARSED_ARGUMENTS)
    message(FATAL_ERROR "Unknown keywords given to CjyxMacroBuildModuleMRML(): \"${MODULEMRML_UNPARSED_ARGUMENTS}\"")
  endif()
  ...
  set_property(GLOBAL APPEND PROPERTY CJYX_MODULE_MRML_TARGETS ${MODULEMRML_NAME})

  #-----------------------------------------------------------------------------
  # Update Cjyx_ModuleMRML_INCLUDE_DIRS
  #-----------------------------------------------------------------------------
  set(Cjyx_ModuleMRML_INCLUDE_DIRS
    ${Cjyx_ModuleMRML_INCLUDE_DIRS}
  ...
  if(NOT ${MODULEMRML_DISABLE_WRAP_PYTHON} AND VTK_WRAP_PYTHON AND BUILD_SHARED_LIBS)
    ...
    # Export target
    set_property(GLOBAL APPEND PROPERTY Cjyx_TARGETS ${MODULEMRML_NAME}Python)
  endif()
