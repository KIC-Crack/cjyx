...
//-----------------------------------------------------------------------------
vtkMRMLCommandLineModuleNode* qCjyxCLIModuleWidgetPrivate::commandLineModuleNode()const
{
...
void qCjyxCLIModuleWidgetPrivate::setupUi(qCjyxWidget* widget)
{
  ...
  // an update. Scene in MRMLCommandLineModuleNodeSelector will be set later by qCjyxAbstractCoreModule.
...
//-----------------------------------------------------------------------------
void qCjyxCLIModuleWidgetPrivate::setDefaultNodeValue(vtkMRMLNode* commandLineModuleNode)
{
  vtkMRMLCommandLineModuleNode * node =
    vtkMRMLCommandLineModuleNode::SafeDownCast(commandLineModuleNode);
  Q_ASSERT(node);
...
//-----------------------------------------------------------------------------
vtkMRMLCommandLineModuleNode * qCjyxCLIModuleWidget::currentCommandLineModuleNode()const
{
...
//-----------------------------------------------------------------------------
void qCjyxCLIModuleWidget::run(vtkMRMLCommandLineModuleNode* parameterNode, bool waitForCompletion)
{
  Q_D(qCjyxCLIModuleWidget);
  Q_ASSERT(d->logic());
...
//-----------------------------------------------------------------------------
void qCjyxCLIModuleWidget::cancel(vtkMRMLCommandLineModuleNode* node)
{
  if (!node)
    {
    return;
...
//-----------------------------------------------------------
bool qCjyxCLIModuleWidget::setEditedNode(vtkMRMLNode* node,
...
//-----------------------------------------------------------
double qCjyxCLIModuleWidget::nodeEditable(vtkMRMLNode* node)
{
