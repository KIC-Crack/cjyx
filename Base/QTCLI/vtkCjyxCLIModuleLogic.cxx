...
typedef std::pair<vtkCjyxCLIModuleLogic *, vtkMRMLCommandLineModuleNode *> LogicNodePair;
...
//-----------------------------------------------------------------------------
vtkMRMLCommandLineModuleNode* vtkCjyxCLIModuleLogic::CreateNode()
{
...
//-----------------------------------------------------------------------------
vtkMRMLCommandLineModuleNode* vtkCjyxCLIModuleLogic::CreateNodeInScene()
{
                             ...
                             CommandLineModuleType commandType)
{
  ...
  // MRML scene, then the node is encoded as cjyx:%p#%s where the
  ...
  if (tag == "image")
    ...
    if ( commandType == CommandLineModule
      ...
      sprintf(tname, "cjyx:%p#%s", this->GetMRMLScene(), name.c_str());
...
//-----------------------------------------------------------------------------
void vtkCjyxCLIModuleLogic::ApplyAndWait ( vtkMRMLCommandLineModuleNode* node, bool updateDisplay )
{
...
//-----------------------------------------------------------------------------
void vtkCjyxCLIModuleLogic::Apply ( vtkMRMLCommandLineModuleNode* node, bool updateDisplay )
{
  bool ret;
...
//----------------------------------------------------------------------------
void vtkCjyxCLIModuleLogic::SetMRMLSceneInternal(vtkMRMLScene * newScene)
{
...
//----------------------------------------------------------------------------
void vtkCjyxCLIModuleLogic::OnMRMLSceneNodeAdded(vtkMRMLNode* node)
{
...
//----------------------------------------------------------------------------
void vtkCjyxCLIModuleLogic::ProcessMRMLLogicsEvents(vtkObject* caller,
                                                      unsigned long event,
                                                      void * callData)
{
...
//---------------------------------------------------------------------------
void vtkCjyxCLIModuleLogic::AddCompleteModelHierarchyToMiniScene(vtkMRMLScene *miniscene, vtkMRMLModelHierarchyNode *mhnd,
