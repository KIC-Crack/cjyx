...
//---------------------------------------------------------------------------
void qCjyxViewersToolBarPrivate::setMRMLScene(vtkMRMLScene* newScene)
{
  Q_Q(qCjyxViewersToolBar);
...
//---------------------------------------------------------------------------
void qCjyxViewersToolBarPrivate::updateWidgetFromMRML()
{
...
//---------------------------------------------------------------------------
void qCjyxViewersToolBarPrivate::OnMRMLSceneStartClose()
{
  Q_Q(qCjyxViewersToolBar);
  q->setEnabled(false);
}
...
//---------------------------------------------------------------------------
void qCjyxViewersToolBarPrivate::OnMRMLSceneEndImport()
{
  Q_Q(qCjyxViewersToolBar);
...
//---------------------------------------------------------------------------
void qCjyxViewersToolBarPrivate::OnMRMLSceneEndClose()
{
  Q_Q(qCjyxViewersToolBar);
  Q_ASSERT(this->MRMLScene);
...
//---------------------------------------------------------------------------
void qCjyxViewersToolBar::setMRMLScene(vtkMRMLScene* newScene)
{
  Q_D(qCjyxViewersToolBar);
