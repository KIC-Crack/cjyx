...
//-----------------------------------------------------------------------------
QString qCjyxExportNodeDialogPrivate::forceFileNameExtension(const QString& fileName, const QString& extension, vtkMRMLNode* node)
{
  qCjyxCoreIOManager* coreIOManager = qCjyxCoreApplication::application()->coreIOManager();
...
//-----------------------------------------------------------------------------
QString qCjyxExportNodeDialogPrivate::defaultFilename(vtkMRMLNode* node, QString extension)
{
...
//-----------------------------------------------------------------------------
const QList<vtkMRMLStorableNode*> & qCjyxExportNodeDialogPrivate::nodeList() const
{
...
//-----------------------------------------------------------------------------
QString qCjyxExportNodeDialogPrivate::recommendedFilename(vtkMRMLStorableNode* node) const
{
  if (!this->FilenameLineEdit->isEnabled())
    {
...
//-----------------------------------------------------------------------------
QDir qCjyxExportNodeDialogPrivate::getSubjectHierarchyBasedDirectory(vtkMRMLStorableNode* node) const
{
...
//-----------------------------------------------------------------------------
vtkMRMLStorableNode* qCjyxExportNodeDialogPrivate::theOnlyNode() const
{
  if (this->nodeList().size()!=1)
    {
