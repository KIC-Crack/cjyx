...
//---------------------------------------------------------------------------
void qCjyxMouseModeToolBarPrivate::setMRMLScene(vtkMRMLScene* newScene)
{
  Q_Q(qCjyxMouseModeToolBar);
...
//---------------------------------------------------------------------------
void qCjyxMouseModeToolBarPrivate::updateWidgetFromMRML()
{
  Q_Q(qCjyxMouseModeToolBar);
...
//---------------------------------------------------------------------------
void qCjyxMouseModeToolBarPrivate::onMRMLSceneStartBatchProcess()
{
  Q_Q(qCjyxMouseModeToolBar);
  q->setEnabled(false);
}
...
//---------------------------------------------------------------------------
void qCjyxMouseModeToolBarPrivate::onMRMLSceneEndBatchProcess()
{
  Q_Q(qCjyxMouseModeToolBar);
...
//---------------------------------------------------------------------------
void qCjyxMouseModeToolBar::setMRMLScene(vtkMRMLScene* newScene)
{
  Q_D(qCjyxMouseModeToolBar);
...
//-----------------------------------------------------------------------------
vtkMRMLInteractionNode* qCjyxMouseModeToolBar::interactionNode()const
{
  Q_D(const qCjyxMouseModeToolBar);
...
//-----------------------------------------------------------------------------
void qCjyxMouseModeToolBar::setInteractionNode(vtkMRMLInteractionNode* interactionNode)
{
  Q_D(qCjyxMouseModeToolBar);
