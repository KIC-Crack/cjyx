...
class SitkUtilsTests(unittest.TestCase):
    ...
    def test_SimpleITK_CjyxPushPull(self):
        ...
        volumeNode1Copy = su.PushVolumeToCjyx(sitkimage, name="MRHead", className="vtkMRMLScalarVolumeNode")
        ...
        volumeNode1Modified = su.PushVolumeToCjyx(sitkimage, name="ImageChanged", className="vtkMRMLScalarVolumeNode")
