...
def test_nrrd_dwi_load(first_file, second_file=None):
    ...
    # load NRRD into Cjyx
    storagenode = cjyx.vtkMRMLNRRDStorageNode()
    storagenode.SetFileName(first_file)
    dw_node = cjyx.vtkMRMLDiffusionWeightedVolumeNode()
...
def test_nrrd_dwi_roundtrip(test_nrrd_path):
    ...
    storagenode1 = cjyx.vtkMRMLNRRDStorageNode()
    storagenode1.SetFileName(test_nrrd_path)
    dw_node1 = cjyx.vtkMRMLDiffusionWeightedVolumeNode()
    ...
    # re-save NRRD again
    storagenode2 = cjyx.vtkMRMLNRRDStorageNode()
