...
class ShaderPropertiesTest(ScriptedLoadableModuleTest):
    ...
    def setUp(self):
        ...
        layoutManager.setLayout(cjyx.vtkMRMLLayoutNode.CjyxLayoutConventionalView)
    ...
    def testWedgeCut(self):
        ...
        volumeRenderingNode = cjyx.mrmlScene.GetFirstNodeByName('VolumeRendering')
        ...
        markupNode = cjyx.mrmlScene.AddNode(cjyx.vtkMRMLMarkupsLineNode())
        ...
        def GetLineEndpoints():
            fn = cjyx.util.getNode('vtkMRMLMarkupsLineNode1')
            endpoints = []
            for n in range(2):
        ...
        def GetShaderPropertyNode():
            return cjyx.util.getNode('vtkMRMLShaderPropertyNode1')
        ...
        # ------------------------------------------------------
        displayNode = cjyx.util.getNodesByClass('vtkMRMLGPURayCastVolumeRenderingDisplayNode')[0]
        shaderPropNode = displayNode.GetOrCreateShaderPropertyNode(cjyx.mrmlScene)
    ...
    def testSphereCut(self):
        ...
        def GetPointPosition():
            fn = cjyx.util.getNode('vtkMRMLMarkupsFiducialNode1')
            p = [0.0, 0.0, 0.0]
