...
class FiducialLayoutSwitchBug1914Test(ScriptedLoadableModuleTest):
    ...
    def test_FiducialLayoutSwitchBug1914(self):
        ...
        lm.setLayout(cjyx.vtkMRMLLayoutNode.CjyxLayoutConventionalView)
        ...
        markupNode = cjyx.mrmlScene.AddNewNodeByClass("vtkMRMLMarkupsFiducialNode")
        ...
        self.takeScreenshot('FiducialLayoutSwitchBug1914-StartingPosition', 'Point starting position', cjyx.qMRMLScreenShotDialog.Red)

        # Switch to red slice only
        lm.setLayout(cjyx.vtkMRMLLayoutNode.CjyxLayoutOneUpRedSliceView)
        ...
        self.takeScreenshot('FiducialLayoutSwitchBug1914-EndingPosition', 'Point ending position', cjyx.qMRMLScreenShotDialog.Red)
        ...
        if enableScreenshots == 1:
            ...
            startView = cjyx.mrmlScene.GetFirstNodeByName('FiducialLayoutSwitchBug1914-StartingPosition')
            startShot = startView.GetScreenShot()
            endView = cjyx.mrmlScene.GetFirstNodeByName('FiducialLayoutSwitchBug1914-EndingPosition')
            ...
            annotationLogic.CreateSnapShot("FiducialLayoutSwitchBug1914-Diff", "Difference between starting and ending point positions",
                                           cjyx.qMRMLScreenShotDialog.Red, screenshotScaleFactor, shotDiff)
