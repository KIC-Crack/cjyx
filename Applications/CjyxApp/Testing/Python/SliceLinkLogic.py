...
class SliceLinkLogicTest(ScriptedLoadableModuleTest):
    ...
    def test_SliceLinkLogic1(self):
        ...
        ln = cjyx.mrmlScene.GetFirstNodeByClass('vtkMRMLLayoutNode')
        ...
        compareNode2 = cjyx.util.getNode('vtkMRMLSliceNodeCompare2')
        compareCNode2 = cjyx.util.getNode('vtkMRMLSliceCompositeNodeCompare2')
        self.assertEqual(compareCNode2.GetForegroundVolumeID(), volumeNode.GetID())
        compareNode3 = cjyx.util.getNode('vtkMRMLSliceNodeCompare3')
        compareCNode3 = cjyx.util.getNode('vtkMRMLSliceCompositeNodeCompare3')
