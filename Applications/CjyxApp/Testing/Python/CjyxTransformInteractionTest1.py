...
class CjyxTransformInteractionTest1Logic(ScriptedLoadableModuleLogic):
    ...
    def addTransform(self):
        ...
        """
        transformNode = cjyx.mrmlScene.AddNode(cjyx.vtkMRMLTransformNode())
        transformDisplayNode = cjyx.mrmlScene.AddNode(cjyx.vtkMRMLTransformDisplayNode())
...
class CjyxTransformInteractionTest1Test(ScriptedLoadableModuleTest):
    ...
    def test_3D_interactionDefaults(self):
        ...
        cjyx.app.layoutManager().layout = cjyx.vtkMRMLLayoutNode.CjyxLayoutOneUp3DView
    ...
    def test_3D_interaction2Models(self):
        ...
        centeredCubeNode = cjyx.mrmlScene.AddNode(cjyx.vtkMRMLModelNode())
        ...
        movedCubeNode = cjyx.mrmlScene.AddNode(cjyx.vtkMRMLModelNode())
    ...
    def test_3D_interactionSerialization(self):
        ...
        cjyx.mrmlScene.RemoveNode(tNode)
        cjyx.mrmlScene.RemoveNode(tdNode)
        cjyx.mrmlScene.Clear(0)
    ...
    def test_3D_boundsUpdateROI(self):
        ...
        # Setup
        roiNode = cjyx.mrmlScene.AddNode(cjyx.vtkMRMLAnnotationROINode())
