...
class sceneImport2428Test(ScriptedLoadableModuleTest):
    ...
    def test_sceneImport24281(self):
        ...
        headLabel = cjyx.mrmlScene.AddNewNodeByClass('vtkMRMLLabelMapVolumeNode')
        ...
        outHierarchy = cjyx.vtkMRMLModelHierarchyNode()
        outHierarchy.SetScene(cjyx.mrmlScene)
        outHierarchy.SetName("sceneImport2428Hierachy")
        cjyx.mrmlScene.AddNode(outHierarchy)
        ...
        success = success and (cjyx.mrmlScene.GetNumberOfNodesByClass("vtkMRMLModelNode") > 3)
    ...
    verifyModels()
        ...
        fileNamesInScene = []
        success = True
        numModels = cjyx.mrmlScene.GetNumberOfNodesByClass("vtkMRMLModelNode")
        for n in range(numModels):
            modelNode = cjyx.mrmlScene.GetNthNodeByClass(n, "vtkMRMLModelNode")
