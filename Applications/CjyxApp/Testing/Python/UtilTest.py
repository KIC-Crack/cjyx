...
class UtilTestTest(ScriptedLoadableModuleTest):
    ...
    def test_setSliceViewerLayers(self):
        ...
        layoutManager.layout = cjyx.vtkMRMLLayoutNode.CjyxLayoutOneUpRedSliceView

        redSliceCompositeNode = cjyx.mrmlScene.GetNodeByID('vtkMRMLSliceCompositeNodeRed')
        ...
        labelmapNode = volumesLogic.CreateAndAddLabelVolume(cjyx.mrmlScene, backgroundNode, 'Labelmap')
        ...
        otherLabelmapNode = volumesLogic.CreateAndAddLabelVolume(cjyx.mrmlScene, backgroundNode, 'OtherLabelmap')
    ...
    def test_updateTableFromArray(self):
        ...
        tableNode1 = cjyx.mrmlScene.AddNewNodeByClass("vtkMRMLTableNode")
        ...
        tableNode2 = cjyx.mrmlScene.AddNewNodeByClass("vtkMRMLTableNode")
    ...
    def test_arrayFromModelPoints(self):
        ...
        sphere.Update()
        modelNode = cjyx.mrmlScene.AddNewNodeByClass('vtkMRMLModelNode')
    ...
    def test_arrayFromTransformMatrix(self):
        ...
        parentTransformNode = cjyx.mrmlScene.AddNewNodeByClass('vtkMRMLTransformNode')
    ...
    def test_arrayFromMarkupsControlPoints(self):
        ...
        markupsNode = cjyx.mrmlScene.AddNewNodeByClass('vtkMRMLMarkupsFiducialNode')
