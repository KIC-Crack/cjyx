...
class BRAINSFitRigidRegistrationCrashIssue4139Test(ScriptedLoadableModuleTest):
    ...
    def test_BRAINSFitRigidRegistrationCrashIssue4139(self):
        ...
        outputTransform = cjyx.vtkMRMLLinearTransformNode()
        cjyx.mrmlScene.AddNode(outputTransform)

        outputVolume = cjyx.vtkMRMLScalarVolumeNode()
        cjyx.mrmlScene.AddNode(outputVolume)
