...
class RSNAVisTutorialTest(ScriptedLoadableModuleTest):
    ...
    def test_Part1DICOM(self, enableScreenshotsFlag=0, screenshotScaleFactor=1):
        ...
        try:
            ...
            layoutManager.setLayout(cjyx.vtkMRMLLayoutNode.CjyxLayoutConventionalWidescreenView)
            ...
            abdomenVolume = cjyx.mrmlScene.GetFirstNodeByName('6: CT_Thorax_Abdomen')
            ...
            annotationROI = cjyx.mrmlScene.GetFirstNodeByName('AnnotationROI')
    ...
    def test_Part2Head(self, enableScreenshotsFlag=0, screenshotScaleFactor=1):
        ...
        try:
            ...
            cameras = cjyx.util.getNodes('vtkMRMLCameraNode*')
            ...
            clip = cjyx.util.getNode(pattern='vtkMRMLClipModelsNode1')
    ...
    def test_Part3Liver(self, enableScreenshotsFlag=0, screenshotScaleFactor=1):
        ...
        try:
            ...
            models = cjyx.util.getNodes('vtkMRMLModelNode*')
