...
int vtkMRMLDisplayableManagerFactoriesTest1(int argc, char* argv[])
{
  ...
  vtkMRMLSliceViewDisplayableManagerFactory * cjyxViewFactory = vtkMRMLSliceViewDisplayableManagerFactory::GetInstance();
  if (!cjyxViewFactory)
    {
    std::cerr << "Line " << __LINE__
      << " - Problem with vtkMRMLThreeDViewDisplayableManagerFactory::GetInstance() method"
  ...
  cjyxViewFactory->RegisterDisplayableManager("vtkMRMLTestSliceViewDisplayableManager");
  cjyxViewFactory->RegisterDisplayableManager("vtkMRMLTestCustomDisplayableManager");
