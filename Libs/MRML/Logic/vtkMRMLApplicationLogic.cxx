...
//----------------------------------------------------------------------------
std::string vtkMRMLApplicationLogic::UnpackCjyxDataBundle(const char *sdbFilePath, const char *temporaryDirectory)
{
  return vtkMRMLScene::UnpackCjyxDataBundle(sdbFilePath, temporaryDirectory);
}

//----------------------------------------------------------------------------
bool vtkMRMLApplicationLogic::OpenCjyxDataBundle(const char* sdbFilePath, const char* temporaryDirectory)
{
  ...
  std::string mrmlFile = this->UnpackCjyxDataBundle(sdbFilePath, temporaryDirectory);
...
//----------------------------------------------------------------------------
bool vtkMRMLApplicationLogic::SaveSceneToCjyxDataBundleDirectory(const char* sdbDir, vtkImageData* screenShot)
{
  // Overview:
  ...
  return this->GetMRMLScene()->SaveSceneToCjyxDataBundleDirectory(sdbDir, screenShot);
}
