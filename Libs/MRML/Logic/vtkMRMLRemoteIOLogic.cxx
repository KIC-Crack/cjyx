...
void vtkMRMLRemoteIOLogic::AddDataIOToScene()
{
  ...
  // from qCjyxCoreApplication::setMRMLScene(vtkMRMLScene* newMRMLScene)
  // should be moved to here so they can be used outside of the
  // context of a qCjyx based application
  // Update 2015/03/20: split qCjyxCoreApplication::setMRMLScene so that
  // a user can call vtkCjyxApplicationLogic::SetMRMLSceneDataIO to trigger
