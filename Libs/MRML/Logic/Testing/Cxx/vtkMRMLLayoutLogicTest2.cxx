...
int vtkMRMLLayoutLogicTest2(int , char * [] )
{
  ...
  // ConventionalView
  layout->SetViewArrangement(vtkMRMLLayoutNode::CjyxLayoutConventionalView);
  ...
  // 3D layout
  layout->SetViewArrangement(vtkMRMLLayoutNode::CjyxLayoutOneUp3DView);
  ...
  // RED layout
  layout->SetViewArrangement(vtkMRMLLayoutNode::CjyxLayoutOneUpRedSliceView);
  if (logic->GetViewNodes()->GetNumberOfItems() != 1)
    {
    std::cerr << __LINE__ << " Wrong number of views returned:"
              << logic->GetViewNodes()->GetNumberOfItems() << std::endl;
  ...
  // YELLOW layout
  layout->SetViewArrangement(vtkMRMLLayoutNode::CjyxLayoutOneUpYellowSliceView);
  if (logic->GetViewNodes()->GetNumberOfItems() != 1)
    {
    std::cerr << __LINE__ <<  " Wrong number of views returned:"
              << logic->GetViewNodes()->GetNumberOfItems() << std::endl;
  ...
  // GREEN layout
  layout->SetViewArrangement(vtkMRMLLayoutNode::CjyxLayoutOneUpGreenSliceView);
  if (logic->GetViewNodes()->GetNumberOfItems() != 1)
    {
    std::cerr << __LINE__ << " Wrong number of views returned:"
              << logic->GetViewNodes()->GetNumberOfItems() << std::endl;
