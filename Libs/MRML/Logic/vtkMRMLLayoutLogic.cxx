...
vtkMRMLLayoutLogic::vtkMRMLLayoutLogic()
{
  ...
  this->LastValidViewArrangement = vtkMRMLLayoutNode::CjyxLayoutNone;
...
void vtkMRMLLayoutLogic::UpdateFromMRMLScene()
{
  ...
  if (this->LayoutNode->GetViewArrangement() == vtkMRMLLayoutNode::CjyxLayoutNone
...
void vtkMRMLLayoutLogic::UpdateLayoutNode()
{
  ...
  if (sceneLayoutNode)
    ...
    sceneLayoutNode->SetViewArrangement(vtkMRMLLayoutNode::CjyxLayoutInitialView);
...
{
  if (this->LayoutNode &&
      this->LayoutNode->GetViewArrangement() != vtkMRMLLayoutNode::CjyxLayoutNone)
    {
...
void vtkMRMLLayoutLogic::UpdateCompareViewLayoutDefinitions()
{
  ...
  if (this->LayoutNode->IsLayoutDescription(vtkMRMLLayoutNode::CjyxLayoutCompareView))
    {
    this->LayoutNode->SetLayoutDescription(vtkMRMLLayoutNode::CjyxLayoutCompareView,
                                           compareView.str().c_str());
    }
  else
    {
    this->LayoutNode->AddLayoutDescription(vtkMRMLLayoutNode::CjyxLayoutCompareView,
                                           compareView.str().c_str());
    }
  ...
  if (this->LayoutNode->IsLayoutDescription(vtkMRMLLayoutNode::CjyxLayoutCompareWidescreenView))
    {
    this->LayoutNode->SetLayoutDescription(vtkMRMLLayoutNode::CjyxLayoutCompareWidescreenView,
                                        compareWidescreenView.str().c_str());
    }
  else
    {
    this->LayoutNode->AddLayoutDescription(vtkMRMLLayoutNode::CjyxLayoutCompareWidescreenView,
                                        compareWidescreenView.str().c_str());
    }
  ...
  if (this->LayoutNode->IsLayoutDescription(vtkMRMLLayoutNode::CjyxLayoutCompareGridView))
    {
    this->LayoutNode->SetLayoutDescription(vtkMRMLLayoutNode::CjyxLayoutCompareGridView,
                                           compareViewGrid.str().c_str());
    }
  else
    {
    this->LayoutNode->AddLayoutDescription(vtkMRMLLayoutNode::CjyxLayoutCompareGridView,
                                           compareViewGrid.str().c_str());
    }
...
void vtkMRMLLayoutLogic::AddDefaultLayouts()
{
  ...
  int wasModifying = this->LayoutNode->StartModify();
  this->LayoutNode->AddLayoutDescription(vtkMRMLLayoutNode::CjyxLayoutInitialView,
                                         fourUpView);
  this->LayoutNode->AddLayoutDescription(vtkMRMLLayoutNode::CjyxLayoutDefaultView,
                                         conventionalView);
  this->LayoutNode->AddLayoutDescription(vtkMRMLLayoutNode::CjyxLayoutConventionalView,
                                         conventionalView);
  this->LayoutNode->AddLayoutDescription(vtkMRMLLayoutNode::CjyxLayoutFourUpView,
                                         fourUpView);
  this->LayoutNode->AddLayoutDescription(vtkMRMLLayoutNode::CjyxLayoutOneUp3DView,
                                         oneUp3DView);
  this->LayoutNode->AddLayoutDescription(vtkMRMLLayoutNode::CjyxLayout3DTableView,
                                         threeDTableView);
  this->LayoutNode->AddLayoutDescription(vtkMRMLLayoutNode::CjyxLayoutOneUpRedSliceView,
                                         oneUpRedView);
  this->LayoutNode->AddLayoutDescription(vtkMRMLLayoutNode::CjyxLayoutOneUpYellowSliceView,
                                         oneUpYellowView);
  this->LayoutNode->AddLayoutDescription(vtkMRMLLayoutNode::CjyxLayoutOneUpGreenSliceView,
                                         oneUpGreenView);
  this->LayoutNode->AddLayoutDescription(vtkMRMLLayoutNode::CjyxLayoutTabbed3DView,
                                         tabbed3DView);
  this->LayoutNode->AddLayoutDescription(vtkMRMLLayoutNode::CjyxLayoutTabbedSliceView,
                                         tabbedSliceView);
  this->LayoutNode->AddLayoutDescription(vtkMRMLLayoutNode::CjyxLayoutThreeOverThreeView,
                                         threeOverThreeView);
  this->LayoutNode->AddLayoutDescription(vtkMRMLLayoutNode::CjyxLayoutFourOverFourView,
                                         fourOverFourView);
  this->LayoutNode->AddLayoutDescription(vtkMRMLLayoutNode::CjyxLayoutDual3DView,
                                         dual3DView);
  this->LayoutNode->AddLayoutDescription(vtkMRMLLayoutNode::CjyxLayoutConventionalWidescreenView,
                                         conventionalWidescreenView);
  this->LayoutNode->AddLayoutDescription(vtkMRMLLayoutNode::CjyxLayoutTriple3DEndoscopyView,
                                         triple3DEndoscopyView);
  this->LayoutNode->AddLayoutDescription(vtkMRMLLayoutNode::CjyxLayoutConventionalPlotView,
                                         conventionalPlotView);
  this->LayoutNode->AddLayoutDescription(vtkMRMLLayoutNode::CjyxLayoutFourUpPlotView,
                                         fourUpPlotView);
  this->LayoutNode->AddLayoutDescription(vtkMRMLLayoutNode::CjyxLayoutFourUpPlotTableView,
                                         fourUpPlotTableView);
  this->LayoutNode->AddLayoutDescription(vtkMRMLLayoutNode::CjyxLayoutOneUpPlotView,
                                         oneUpPlotView);
  this->LayoutNode->AddLayoutDescription(vtkMRMLLayoutNode::CjyxLayoutTwoOverTwoView,
                                         twoOverTwoView);
  this->LayoutNode->AddLayoutDescription(vtkMRMLLayoutNode::CjyxLayoutThreeOverThreePlotView,
                                         threeOverThreePlotView);
  this->LayoutNode->AddLayoutDescription(vtkMRMLLayoutNode::CjyxLayoutFourUpTableView,
                                         fourUpTableView);
  this->LayoutNode->AddLayoutDescription(vtkMRMLLayoutNode::CjyxLayoutSideBySideView,
                                         sideBySideView);
  this->LayoutNode->AddLayoutDescription(vtkMRMLLayoutNode::CjyxLayoutFourByThreeSliceView,
                                         fourByThreeSliceView);
  this->LayoutNode->AddLayoutDescription(vtkMRMLLayoutNode::CjyxLayoutFourByTwoSliceView,
                                         fourByTwoSliceView);
  this->LayoutNode->AddLayoutDescription(vtkMRMLLayoutNode::CjyxLayoutFiveByTwoSliceView,
                                         fiveByTwoSliceView);
  this->LayoutNode->AddLayoutDescription(vtkMRMLLayoutNode::CjyxLayoutThreeByThreeSliceView,
...
{
  int layout = vtkMRMLLayoutNode::CjyxLayoutMaximizedView;
