...
public:
  ...
  /// If userMessages is not nullptr then the method may add messages to it about issues
  /// encountered during the operation.
  static std::string UnpackCjyxDataBundle(const char* sdbFilePath, const char* temporaryDirectory, vtkMRMLMessageCollection* userMessages=nullptr);
  ...
  /// encountered during the operation.
  /// Returns false if the save failed
  bool SaveSceneToCjyxDataBundleDirectory(const char* sdbDir, vtkImageData* thumbnail=nullptr, vtkMRMLMessageCollection* userMessages=nullptr);
...
protected:
  ...
  /// If userMessages is not nullptr then the method may add messages to it about issues
  /// encountered during the operation.
  bool SaveStorableNodeToCjyxDataBundleDirectory(vtkMRMLStorableNode* storableNode, std::string& dataDir,
