...
bool vtkMRMLScene::ReadFromMRB(const char* fullName, bool clear/*=false*/, vtkMRMLMessageCollection* userMessagesInput/*=nullptr*/)
{
  ...
  std::string mrmlFile = vtkMRMLScene::UnpackCjyxDataBundle(fullName, unpackDir.c_str());
...
//----------------------------------------------------------------------------
std::string vtkMRMLScene::UnpackCjyxDataBundle(const char* sdbFilePath, const char* temporaryDirectory, vtkMRMLMessageCollection* userMessages/*=nullptr*/)
{
...
//----------------------------------------------------------------------------
bool vtkMRMLScene::SaveSceneToCjyxDataBundleDirectory(const char* sdbDir,
  vtkImageData* screenShot/*=nullptr*/, vtkMRMLMessageCollection* userMessagesInput/*=nullptr*/)
{
  ...
  if (!sdbDir)
    {
    vtkErrorToMessageCollectionMacro(userMessages, "vtkMRMLScene::SaveSceneToCjyxDataBundleDirectory",
  ...
  for (int i = 0; i < numNodes; ++i)
    ...
    if (!mrmlNode)
      {
      vtkWarningToMessageCollectionMacro(userMessages, "vtkMRMLScene::SaveSceneToCjyxDataBundleDirectory",
...
//----------------------------------------------------------------------------
bool vtkMRMLScene::SaveStorableNodeToCjyxDataBundleDirectory(vtkMRMLStorableNode* storableNode, std::string &dataDir,
