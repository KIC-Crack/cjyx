...
vtkMRMLLayoutNode::vtkMRMLLayoutNode()
{
  ...
  this->GUIPanelLR = 0;
  this->ViewArrangement = vtkMRMLLayoutNode::CjyxLayoutNone;
  ...
  this->AddLayoutDescription(vtkMRMLLayoutNode::CjyxLayoutNone, "");
}
...
void vtkMRMLLayoutNode::ReadXMLAttributes(const char** atts)
{
  ...
  while (*atts != nullptr)
    ...
    if (!strcmp(attName, "currentViewArrangement"))
      ...
      if (this->ViewArrangement < vtkMRMLLayoutNode::CjyxLayoutInitialView)
        {
        this->ViewArrangement = vtkMRMLLayoutNode::CjyxLayoutInitialView;
        }
      }
...
{
  if (this->GetViewArrangement() == vtkMRMLLayoutNode::CjyxLayoutCustomView)
    {
    return;
    }
  ...
  if (!this->IsLayoutDescription(viewArrangement))
    ...
    viewArrangement = vtkMRMLLayoutNode::CjyxLayoutDefaultView;
    }
