...
int qMRMLLayoutManagerTest3(int argc, char * argv[] )
{
  ...
  layoutNode->SetViewArrangement(vtkMRMLLayoutNode::CjyxLayoutConventionalView);
  if (!checkViewArrangement(__LINE__, layoutManager, layoutNode, vtkMRMLLayoutNode::CjyxLayoutConventionalView))
    {
    return EXIT_FAILURE;
    }
