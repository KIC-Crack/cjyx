...
void qMRMLTableView::plotSelection()
{
  ...
  if (viewArray != vtkMRMLLayoutNode::CjyxLayoutConventionalPlotView  &&
      viewArray != vtkMRMLLayoutNode::CjyxLayoutFourUpPlotView        &&
      viewArray != vtkMRMLLayoutNode::CjyxLayoutFourUpPlotTableView   &&
      viewArray != vtkMRMLLayoutNode::CjyxLayoutOneUpPlotView         &&
      viewArray != vtkMRMLLayoutNode::CjyxLayoutThreeOverThreePlotView)
    {
    layoutNode->SetViewArrangement(vtkMRMLLayoutNode::CjyxLayoutConventionalPlotView);
    }
