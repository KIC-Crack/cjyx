...
"""
    ...
    def setupOptionsFrame(self):
        ...
        # Object scale slider
        self.objectScaleMmSlider = cjyx.qMRMLSliderWidget()
        self.objectScaleMmSlider.setMRMLScene(cjyx.mrmlScene)
    ...
    def onApply(self):
        ...
        masterVolumeNode = cjyx.vtkMRMLScalarVolumeNode()
        cjyx.mrmlScene.AddNode(masterVolumeNode)
        ...
        mergedLabelmapNode = cjyx.vtkMRMLLabelMapVolumeNode()
        cjyx.mrmlScene.AddNode(mergedLabelmapNode)
        ...
        cjyx.mrmlScene.RemoveNode(masterVolumeNode)
        cjyx.mrmlScene.RemoveNode(mergedLabelmapNode)
