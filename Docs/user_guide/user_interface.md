...
Cjyx stores all loaded data in a data repository, called the "scene" (or Cjyx scene or MRML scene). Each data set, such as an image volume, surface model, or point set, is represented in the scene as a "node".
