...
# Create plot
plotSeriesNode = cjyx.mrmlScene.AddNewNodeByClass("vtkMRMLPlotSeriesNode", volumeNode.GetName() + " histogram")
...
plotChartNode = cjyx.mrmlScene.AddNewNodeByClass("vtkMRMLPlotChartNode")
