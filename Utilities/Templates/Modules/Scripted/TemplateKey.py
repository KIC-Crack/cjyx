...
class TemplateKeyWidget(ScriptedLoadableModuleWidget, VTKObservationMixin):
    ...
    def setup(self):
        ...
        uiWidget.setMRMLScene(cjyx.mrmlScene)
    ...
    def initializeParameterNode(self):
        ...
        if not self._parameterNode.GetNodeReference("InputVolume"):
            firstVolumeNode = cjyx.mrmlScene.GetFirstNodeByClass("vtkMRMLScalarVolumeNode")
            if firstVolumeNode:
...
class TemplateKeyTest(ScriptedLoadableModuleTest):
    ...
    def test_TemplateKey1(self):
        ...
        outputVolume = cjyx.mrmlScene.AddNewNodeByClass("vtkMRMLScalarVolumeNode")
        threshold = 100
