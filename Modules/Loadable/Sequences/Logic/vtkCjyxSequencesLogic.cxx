...
//---------------------------------------------------------------------------
void vtkCjyxSequencesLogic::SetMRMLSceneInternal(vtkMRMLScene * newScene)
{
...
//---------------------------------------------------------------------------
void vtkCjyxSequencesLogic::UpdateFromMRMLScene()
{
  if (this->GetMRMLScene()==nullptr)
    {
    vtkErrorMacro("Scene is invalid");
...
//---------------------------------------------------------------------------
void vtkCjyxSequencesLogic::OnMRMLSceneNodeAdded(vtkMRMLNode* node)
{
  if (node == nullptr)
    {
...
//---------------------------------------------------------------------------
void vtkCjyxSequencesLogic::OnMRMLSceneNodeRemoved(vtkMRMLNode* node)
{
  if (node == nullptr)
    {
...
//----------------------------------------------------------------------------
vtkMRMLSequenceNode* vtkCjyxSequencesLogic::AddSequence(const char* filename, vtkMRMLMessageCollection* userMessages/*=nullptr*/)
{
...
//---------------------------------------------------------------------------
void vtkCjyxSequencesLogic::UpdateProxyNodesFromSequences(vtkMRMLSequenceBrowserNode* browserNode)
{
#ifdef ENABLE_PERFORMANCE_PROFILING
...
//---------------------------------------------------------------------------
void vtkCjyxSequencesLogic::UpdateSequencesFromProxyNodes(vtkMRMLSequenceBrowserNode* browserNode, vtkMRMLNode* proxyNode)
{
  if (this->UpdateProxyNodesFromSequencesInProgress || this->UpdateSequencesFromProxyNodesInProgress)
    {
...
//---------------------------------------------------------------------------
vtkMRMLSequenceNode* vtkCjyxSequencesLogic::AddSynchronizedNode(vtkMRMLNode* sNode, vtkMRMLNode* proxyNode, vtkMRMLNode* bNode)
{
...
//---------------------------------------------------------------------------
void vtkCjyxSequencesLogic::ProcessMRMLNodesEvents(vtkObject *caller, unsigned long event, void *callData)
{
...
//---------------------------------------------------------------------------
void vtkCjyxSequencesLogic::GetCompatibleNodesFromScene(vtkCollection* compatibleNodes, vtkMRMLSequenceNode* masterSequenceNode)
{
...
//---------------------------------------------------------------------------
bool vtkCjyxSequencesLogic::IsNodeCompatibleForBrowsing(vtkMRMLSequenceNode* masterNode, vtkMRMLSequenceNode* testedNode)
{
...
//---------------------------------------------------------------------------
void vtkCjyxSequencesLogic::GetBrowserNodesForSequenceNode(vtkMRMLSequenceNode* sequenceNode, vtkCollection* foundBrowserNodes)
{
  if (this->GetMRMLScene() == nullptr)
    {
    vtkErrorMacro("Scene is invalid");
...
//---------------------------------------------------------------------------
vtkMRMLSequenceBrowserNode* vtkCjyxSequencesLogic::GetFirstBrowserNodeForSequenceNode(vtkMRMLSequenceNode* sequenceNode)
{
  if (this->GetMRMLScene() == nullptr)
    {
    vtkErrorMacro("Scene is invalid");
...
//---------------------------------------------------------------------------
void vtkCjyxSequencesLogic::GetBrowserNodesForProxyNode(vtkMRMLNode* proxyNode, vtkCollection* foundBrowserNodes)
{
  if (foundBrowserNodes == nullptr)
    {
    vtkErrorMacro("foundBrowserNodes is invalid");
...
//---------------------------------------------------------------------------
vtkMRMLSequenceBrowserNode* vtkCjyxSequencesLogic::GetFirstBrowserNodeForProxyNode(vtkMRMLNode* proxyNode)
{
  if (this->GetMRMLScene() == nullptr)
    {
    vtkErrorMacro("Scene is invalid");
