...
//-----------------------------------------------------------------------------
void qCjyxSequencesModuleWidgetPrivate::GetDataNodeCandidates(vtkCollection* foundNodes, vtkMRMLSequenceNode* sequenceNode)
{
  Q_Q( const qCjyxSequencesModuleWidget );
...
//-----------------------------------------------------------------------------
qMRMLSequenceBrowserToolBar* qCjyxSequencesModuleWidgetPrivate::toolBar()
{
  Q_Q(const qCjyxSequencesModuleWidget);
...
//-----------------------------------------------------------------------------
void qCjyxSequencesModuleWidget::setMRMLScene(vtkMRMLScene* scene)
{
  Q_D(qCjyxSequencesModuleWidget);
...
//-----------------------------------------------------------------------------
void qCjyxSequencesModuleWidget::onMRMLSceneEndImportEvent()
{
  this->updateCandidateNodesWidgetFromMRML(true);
  this->refreshSynchronizedSequenceNodesTable();
}
...
//-----------------------------------------------------------------------------
void qCjyxSequencesModuleWidget::onMRMLSceneEndRestoreEvent()
{
  this->updateCandidateNodesWidgetFromMRML(true);
  this->refreshSynchronizedSequenceNodesTable();
}
...
//-----------------------------------------------------------------------------
void qCjyxSequencesModuleWidget::onMRMLSceneEndBatchProcessEvent()
{
  if (!this->mrmlScene())
    {
    return;
...
//-----------------------------------------------------------------------------
void qCjyxSequencesModuleWidget::onMRMLSceneEndCloseEvent()
{
  if (!this->mrmlScene() || this->mrmlScene()->IsBatchProcessing())
    {
    return;
...
// --------------------------------------------------------------------------
void qCjyxSequencesModuleWidget::setActiveSequenceNode(vtkMRMLSequenceNode* sequenceNode)
{
  Q_D(qCjyxSequencesModuleWidget);
...
//-----------------------------------------------------------------------------
void qCjyxSequencesModuleWidget::updateSequenceItemWidgetFromMRML()
{
  Q_D(qCjyxSequencesModuleWidget);
  ...
  for ( int dataNodeIndex = 0; dataNodeIndex < numberOfDataNodes; dataNodeIndex++ )
    ...
    if (currentDataNode==nullptr)
      {
      qCritical() << "qCjyxSequencesModuleWidget::updateSequenceItemWidgetFromMRML invalid data node";
      continue;
      }
...
//-----------------------------------------------------------------------------
void qCjyxSequencesModuleWidget::updateCandidateNodesWidgetFromMRML(bool forceUpdate /* =false */)
{
  Q_D(qCjyxSequencesModuleWidget);
...
//-----------------------------------------------------------------------------
void qCjyxSequencesModuleWidget::activeBrowserNodeChanged(vtkMRMLNode* node)
{
  Q_D(qCjyxSequencesModuleWidget);
...
//-----------------------------------------------------------------------------
void qCjyxSequencesModuleWidget::sequenceNodeChanged(vtkMRMLNode* inputNode)
{
...
//-----------------------------------------------------------------------------
void qCjyxSequencesModuleWidget::onMRMLInputSequenceInputNodeModified(vtkObject* inputNode)
{
  Q_UNUSED(inputNode);
  this->updateWidgetFromMRML();
}
...
// --------------------------------------------------------------------------
void qCjyxSequencesModuleWidget::setActiveBrowserNode(vtkMRMLSequenceBrowserNode* browserNode)
{
  Q_D(qCjyxSequencesModuleWidget);
  if (!this->mrmlScene() || this->mrmlScene()->IsBatchProcessing())
    {
...
// --------------------------------------------------------------------------
void qCjyxSequencesModuleWidget::setMasterSequenceNode(vtkMRMLSequenceNode* sequenceNode)
{
  Q_D(qCjyxSequencesModuleWidget);
  if (d->ActiveBrowserNode==nullptr)
    {
...
//-----------------------------------------------------------------------------
void qCjyxSequencesModuleWidget::updateWidgetFromMRML()
{
  Q_D(qCjyxSequencesModuleWidget);
...
//-----------------------------------------------------------------------------
void qCjyxSequencesModuleWidget::onProxyNodeChanged(vtkMRMLNode* newProxyNode)
{
  Q_D(qCjyxSequencesModuleWidget);
...
//-----------------------------------------------------------
bool qCjyxSequencesModuleWidget::setEditedNode(vtkMRMLNode* node, QString role /* = QString()*/, QString context /* = QString() */)
{
  Q_UNUSED(context);
  Q_D(qCjyxSequencesModuleWidget);
