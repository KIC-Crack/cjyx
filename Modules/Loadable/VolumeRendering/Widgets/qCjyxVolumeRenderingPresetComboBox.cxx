...
// --------------------------------------------------------------------------
vtkMRMLNode* qCjyxVolumeRenderingPresetComboBox::currentNode()const
{
...
// --------------------------------------------------------------------------
vtkMRMLVolumePropertyNode* qCjyxVolumeRenderingPresetComboBox::mrmlVolumePropertyNode()const
{
  Q_D(const qCjyxVolumeRenderingPresetComboBox);
...
// --------------------------------------------------------------------------
void qCjyxVolumeRenderingPresetComboBox::setCurrentNode(vtkMRMLNode* node)
{
  Q_D(qCjyxVolumeRenderingPresetComboBox);
...
// --------------------------------------------------------------------------
void qCjyxVolumeRenderingPresetComboBox::setMRMLVolumePropertyNode(vtkMRMLNode* node)
{
  Q_D(qCjyxVolumeRenderingPresetComboBox);
...
// --------------------------------------------------------------------------
void qCjyxVolumeRenderingPresetComboBox::applyPreset(vtkMRMLNode* node)
{
  Q_D(qCjyxVolumeRenderingPresetComboBox);
