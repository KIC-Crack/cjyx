...
//----------------------------------------------------------------------------
void vtkCjyxVolumeRenderingLogic::AddVolumeRenderingDisplayNode(vtkMRMLVolumeRenderingDisplayNode* node)
{
...
//----------------------------------------------------------------------------
void vtkCjyxVolumeRenderingLogic::RemoveVolumeRenderingDisplayNode(vtkMRMLVolumeRenderingDisplayNode* node)
{
  DisplayNodesType::iterator it = std::find(this->DisplayNodes.begin(), this->DisplayNodes.end(), node);
  if (it == this->DisplayNodes.end())
  {
...
//----------------------------------------------------------------------------
void vtkCjyxVolumeRenderingLogic::UpdateVolumeRenderingDisplayNode(vtkMRMLVolumeRenderingDisplayNode* node)
{
  if (!node)
    {
...
//----------------------------------------------------------------------------
void vtkCjyxVolumeRenderingLogic::SetMRMLSceneInternal(vtkMRMLScene* scene)
{
...
//----------------------------------------------------------------------------
void vtkCjyxVolumeRenderingLogic::ObserveMRMLScene()
{
  this->RemoveAllVolumeRenderingDisplayNodes();
...
//----------------------------------------------------------------------------
void vtkCjyxVolumeRenderingLogic::OnMRMLSceneNodeAdded(vtkMRMLNode* node)
{
...
//----------------------------------------------------------------------------
void vtkCjyxVolumeRenderingLogic::OnMRMLSceneNodeRemoved(vtkMRMLNode* node)
{
  vtkMRMLVolumeRenderingDisplayNode* vrDisplayNode = vtkMRMLVolumeRenderingDisplayNode::SafeDownCast(node);
  if (vrDisplayNode)
  {
...
//----------------------------------------------------------------------------
void vtkCjyxVolumeRenderingLogic::OnMRMLNodeModified(vtkMRMLNode* node)
{
...
//----------------------------------------------------------------------------
void vtkCjyxVolumeRenderingLogic::UpdateTranferFunctionRangeFromImage(vtkMRMLVolumeRenderingDisplayNode* vspNode)
{
...
//----------------------------------------------------------------------------
void vtkCjyxVolumeRenderingLogic::FitROIToVolume(vtkMRMLVolumeRenderingDisplayNode* vspNode)
{
...
//----------------------------------------------------------------------------
vtkMRMLVolumeRenderingDisplayNode* vtkCjyxVolumeRenderingLogic::CreateDefaultVolumeRenderingNodes(vtkMRMLVolumeNode* volumeNode)
{
  if (!volumeNode)
  {
...
//----------------------------------------------------------------------------
vtkMRMLVolumeRenderingDisplayNode* vtkCjyxVolumeRenderingLogic::CreateVolumeRenderingDisplayNode(const char* renderingClassName)
{
...
//----------------------------------------------------------------------------
vtkMRMLVolumeRenderingDisplayNode* vtkCjyxVolumeRenderingLogic::GetVolumeRenderingDisplayNodeByID(
...
//----------------------------------------------------------------------------
vtkMRMLVolumeRenderingDisplayNode* vtkCjyxVolumeRenderingLogic::GetFirstVolumeRenderingDisplayNode(vtkMRMLVolumeNode *volumeNode)
{
...
//----------------------------------------------------------------------------
vtkMRMLVolumeRenderingDisplayNode* vtkCjyxVolumeRenderingLogic::GetVolumeRenderingDisplayNodeForViewNode(
  vtkMRMLVolumeNode *volumeNode, vtkMRMLViewNode *viewNode)
{
  if (viewNode == nullptr || volumeNode == nullptr)
  {
...
//----------------------------------------------------------------------------
vtkMRMLVolumeRenderingDisplayNode* vtkCjyxVolumeRenderingLogic::GetVolumeRenderingDisplayNodeForViewNode(vtkMRMLViewNode *viewNode)
{
...
//----------------------------------------------------------------------------
vtkMRMLVolumeRenderingDisplayNode* vtkCjyxVolumeRenderingLogic
...
//----------------------------------------------------------------------------
vtkMRMLDisplayableNode* vtkCjyxVolumeRenderingLogic::CreateROINode(vtkMRMLVolumeRenderingDisplayNode *displayNode)
{
  if (displayNode == nullptr)
    {
...
//----------------------------------------------------------------------------
vtkMRMLVolumePropertyNode* vtkCjyxVolumeRenderingLogic::AddVolumePropertyFromFile(const char* filename)
{
  if (!this->GetMRMLScene())
  {
    return nullptr;
...
//---------------------------------------------------------------------------
vtkMRMLShaderPropertyNode* vtkCjyxVolumeRenderingLogic::AddShaderPropertyFromFile(const char* filename)
{
  if (!this->GetMRMLScene())
  {
    return nullptr;
...
//---------------------------------------------------------------------------
vtkMRMLScene* vtkCjyxVolumeRenderingLogic::GetPresetsScene()
{
  if (!this->PresetsScene)
  {
...
//---------------------------------------------------------------------------
vtkMRMLVolumePropertyNode* vtkCjyxVolumeRenderingLogic::GetPresetByName(const char* presetName)
{
...
//---------------------------------------------------------------------------
bool vtkCjyxVolumeRenderingLogic::LoadPresets(vtkMRMLScene* scene)
{
...
//---------------------------------------------------------------------------
void vtkCjyxVolumeRenderingLogic::AddPreset(vtkMRMLVolumePropertyNode* preset, vtkImageData* icon/*=nullptr*/, bool appendToEnd/*=false*/)
{
  if (preset == nullptr)
  {
...
//---------------------------------------------------------------------------
void vtkCjyxVolumeRenderingLogic::RemovePreset(vtkMRMLVolumePropertyNode* preset)
{
  if (preset == nullptr)
  {
    return;
  ...
  vtkMRMLScene* presetScene = this->GetPresetsScene();
  vtkMRMLNode* iconNode = preset->GetNodeReference(vtkCjyxVolumeRenderingLogic::GetIconVolumeReferenceRole());
  if (iconNode != nullptr)
  {
...
//---------------------------------------------------------------------------
bool vtkCjyxVolumeRenderingLogic::SetRecommendedVolumeRenderingProperties(vtkMRMLVolumeRenderingDisplayNode* vspNode)
{
