...
#include "vtkCjyxVolumeRenderingModuleMRMLDisplayableManagerExport.h"
...
class VTK_CJYX_VOLUMERENDERING_MODULE_MRMLDISPLAYABLEMANAGER_EXPORT vtkMRMLVolumeRenderingDisplayableManager
