...
// --------------------------------------------------------------------------
vtkMRMLScalarVolumeNode* qCjyxScalarVolumeDisplayWidget::volumeNode()const
{
...
// --------------------------------------------------------------------------
bool qCjyxScalarVolumeDisplayWidget::isMRMLWindowLevelWidgetEnabled()const
{
  Q_D(const qCjyxScalarVolumeDisplayWidget);
...
// --------------------------------------------------------------------------
void qCjyxScalarVolumeDisplayWidget::setMRMLWindowLevelWidgetEnabled(bool enable)
{
  Q_D(qCjyxScalarVolumeDisplayWidget);
...
// --------------------------------------------------------------------------
vtkMRMLScalarVolumeDisplayNode* qCjyxScalarVolumeDisplayWidget::volumeDisplayNode()const
{
...
// --------------------------------------------------------------------------
void qCjyxScalarVolumeDisplayWidget::setMRMLVolumeNode(vtkMRMLNode* node)
{
  this->setMRMLVolumeNode(vtkMRMLScalarVolumeNode::SafeDownCast(node));
}

// --------------------------------------------------------------------------
void qCjyxScalarVolumeDisplayWidget::setMRMLVolumeNode(vtkMRMLScalarVolumeNode* volumeNode)
{
  Q_D(qCjyxScalarVolumeDisplayWidget);
...
// --------------------------------------------------------------------------
void qCjyxScalarVolumeDisplayWidget::updateWidgetFromMRML()
{
  Q_D(qCjyxScalarVolumeDisplayWidget);
...
// --------------------------------------------------------------------------
void qCjyxScalarVolumeDisplayWidget::setColorNode(vtkMRMLNode* colorNode)
{
  vtkMRMLScalarVolumeDisplayNode* displayNode =
    this->volumeDisplayNode();
