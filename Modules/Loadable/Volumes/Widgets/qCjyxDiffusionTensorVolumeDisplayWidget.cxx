...
// --------------------------------------------------------------------------
vtkMRMLDiffusionTensorVolumeNode* qCjyxDiffusionTensorVolumeDisplayWidget
::volumeNode()const
{
...
// --------------------------------------------------------------------------
vtkMRMLDiffusionTensorVolumeDisplayNode* qCjyxDiffusionTensorVolumeDisplayWidget::volumeDisplayNode()const
{
...
// --------------------------------------------------------------------------
QList<vtkMRMLGlyphableVolumeSliceDisplayNode*> qCjyxDiffusionTensorVolumeDisplayWidget::sliceDisplayNodes()const
{
  Q_D(const qCjyxDiffusionTensorVolumeDisplayWidget);
...
// --------------------------------------------------------------------------
void qCjyxDiffusionTensorVolumeDisplayWidget::setMRMLVolumeNode(vtkMRMLNode* node)
{
  this->setMRMLVolumeNode(vtkMRMLDiffusionTensorVolumeNode::SafeDownCast(node));
}

// --------------------------------------------------------------------------
void qCjyxDiffusionTensorVolumeDisplayWidget::setMRMLVolumeNode(vtkMRMLDiffusionTensorVolumeNode* volumeNode)
{
  Q_D(qCjyxDiffusionTensorVolumeDisplayWidget);
...
// --------------------------------------------------------------------------
void qCjyxDiffusionTensorVolumeDisplayWidget::updateWidgetFromMRML()
{
  Q_D(qCjyxDiffusionTensorVolumeDisplayWidget);
