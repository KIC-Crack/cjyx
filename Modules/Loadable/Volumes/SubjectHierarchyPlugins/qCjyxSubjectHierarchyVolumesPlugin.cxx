...
//------------------------------------------------------------------------------
qMRMLSliceWidget* qCjyxSubjectHierarchyVolumesPluginPrivate::sliceWidgetForSliceCompositeNode(vtkMRMLSliceCompositeNode* compositeNode)
{
...
void qCjyxSubjectHierarchyVolumesPlugin::showViewContextMenuActionsForItem(vtkIdType itemID, QVariantMap eventData)
{
  ...
  vtkMRMLSliceLogic* sliceLogic = qCjyxApplication::application()->applicationLogic()->GetSliceLogic(sliceNode);
  if (!sliceLogic)
    {
    return;
    }
    ...
    if (colorsModuleLogic)
      {
        ...
        vtkMRMLColorLegendDisplayNode* colorLegendDisplayNode = vtkCjyxColorLogic::GetColorLegendDisplayNode(d->SelectedVolumeNode);
...
//---------------------------------------------------------------------------
void qCjyxSubjectHierarchyVolumesPlugin::hideVolumeFromAllViews(vtkMRMLScalarVolumeNode* node)
{
  if (!node || !node->GetID())
    {
    qCritical() << Q_FUNC_INFO << ": nullptr node";
...
{
  vtkMRMLSelectionNode* selectionNode = qCjyxCoreApplication::application()->applicationLogic()->GetSelectionNode();
  if (!selectionNode)
    {
...
//-----------------------------------------------------------------------------
bool qCjyxSubjectHierarchyVolumesPlugin::showItemInView(vtkIdType itemID, vtkMRMLAbstractViewNode* viewNode, vtkIdList* allItemsToShow)
{
  Q_D(qCjyxSubjectHierarchyVolumesPlugin);
