...
//----------------------------------------------------------------------------
void vtkCjyxVolumesLogic::ProcessMRMLNodesEvents(vtkObject *vtkNotUsed(caller),
                                            unsigned long event,
                                            void *callData)
{
...
//----------------------------------------------------------------------------
vtkMRMLVolumeNode* vtkCjyxVolumesLogic::AddArchetypeVolume(
...
//----------------------------------------------------------------------------
vtkMRMLScalarVolumeNode* vtkCjyxVolumesLogic::AddArchetypeScalarVolume(
...
//----------------------------------------------------------------------------
int vtkCjyxVolumesLogic::SaveArchetypeVolume (const char* filename, vtkMRMLVolumeNode *volumeNode)
{
...
//----------------------------------------------------------------------------
vtkMRMLLabelMapVolumeNode* vtkCjyxVolumesLogic
...
vtkCjyxVolumesLogic::CreateAndAddLabelVolume(vtkMRMLScene *scene,
...
//----------------------------------------------------------------------------
vtkMRMLLabelMapVolumeNode *
vtkCjyxVolumesLogic::FillLabelVolumeFromTemplate(vtkMRMLLabelMapVolumeNode *labelNode,
...
//----------------------------------------------------------------------------
vtkMRMLLabelMapVolumeNode *
vtkCjyxVolumesLogic::FillLabelVolumeFromTemplate(vtkMRMLScene *scene,
...
//----------------------------------------------------------------------------
vtkMRMLLabelMapVolumeNode*
vtkCjyxVolumesLogic::CreateLabelVolumeFromVolume(vtkMRMLScene *scene,
...
//----------------------------------------------------------------------------
vtkMRMLScalarVolumeNode* vtkCjyxVolumesLogic::CreateScalarVolumeFromVolume(
...
//----------------------------------------------------------------------------
void
vtkCjyxVolumesLogic::ClearVolumeImageData(vtkMRMLVolumeNode *volumeNode)
{
  if (volumeNode == nullptr)
    {
    return;
...
//----------------------------------------------------------------------------
std::string
vtkCjyxVolumesLogic::CheckForLabelVolumeValidity(vtkMRMLScalarVolumeNode *volumeNode,
                                                   vtkMRMLLabelMapVolumeNode *labelNode)
{
...
//----------------------------------------------------------------------------
std::string
vtkCjyxVolumesLogic::CompareVolumeGeometry(vtkMRMLScalarVolumeNode *volumeNode1,
...
vtkCjyxVolumesLogic::CloneVolume(vtkMRMLVolumeNode *volumeNode, const char *name)
{
...
{
  return vtkMRMLScalarVolumeNode::SafeDownCast(vtkCjyxVolumesLogic::CloneVolumeGeneric(scene, volumeNode, name, cloneImageData));
}
...
//-------------------------------------------------------------------------
void vtkCjyxVolumesLogic::ComputeTkRegVox2RASMatrix ( vtkMRMLVolumeNode *VNode,
                                                                       vtkMatrix4x4 *M )
{
    double dC, dS, dR;
    double Nc, Ns, Nr;
...
//-------------------------------------------------------------------------
void vtkCjyxVolumesLogic::CenterVolume(vtkMRMLVolumeNode* volumeNode)
{
...
//-------------------------------------------------------------------------
void vtkCjyxVolumesLogic::TranslateFreeSurferRegistrationMatrixIntoCjyxRASToRASMatrix( vtkMRMLVolumeNode *V1Node,
...
// --------------------------------------------------------------------------
bool vtkCjyxVolumesLogic::ApplyVolumeDisplayPreset(vtkMRMLVolumeDisplayNode* displayNode, std::string presetId)
{
...
// --------------------------------------------------------------------------
std::string vtkCjyxVolumesLogic::GetAppliedVolumeDisplayPresetId(vtkMRMLVolumeDisplayNode* displayNode)
{
  vtkMRMLScalarVolumeDisplayNode* volumeDisplayNode = vtkMRMLScalarVolumeDisplayNode::SafeDownCast(displayNode);
  if (!volumeDisplayNode)
    {
