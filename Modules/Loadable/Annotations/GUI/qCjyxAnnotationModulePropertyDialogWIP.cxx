...
//------------------------------------------------------------------------------
void qCjyxAnnotationModulePropertyDialog::SaveLinesNode(vtkMRMLAnnotationLinesNode* node)
{
  Q_UNUSED(node);
...
//------------------------------------------------------------------------------
void qCjyxAnnotationModulePropertyDialog::SaveControlPoints(vtkMRMLAnnotationControlPointsNode* node)
{
  Q_UNUSED(node);
  /*
   if (!node)
...
//------------------------------------------------------------------------------
void qCjyxAnnotationModulePropertyDialog::SaveAnnotationNode(vtkMRMLAnnotationNode* node)
{
  Q_UNUSED(node);
  /*
   if (!node)
...
//------------------------------------------------------------------------------
void qCjyxAnnotationModulePropertyDialog::SaveStateForUndo(vtkMRMLNode* node)
{
  Q_UNUSED(node);
  /*
...
//------------------------------------------------------------------------------
void qCjyxAnnotationModulePropertyDialog::UndoLinesNode(vtkMRMLAnnotationLinesNode* node)
{
  Q_UNUSED(node);
  /*
   if (!node)
...
//------------------------------------------------------------------------------
void qCjyxAnnotationModulePropertyDialog::UndoControlPoints(vtkMRMLAnnotationControlPointsNode* node)
{
  Q_UNUSED(node);
  /*
   if (!node)
...
//------------------------------------------------------------------------------
void qCjyxAnnotationModulePropertyDialog::UndoAnnotationNode(vtkMRMLAnnotationNode* node)
{
  Q_UNUSED(node);
  /*
   if (!node)
...
//------------------------------------------------------------------------------
void qCjyxAnnotationModulePropertyDialog::Undo(vtkMRMLNode* node)
{
  Q_UNUSED(node);
  /*
   if (node->IsA("vtkMRMLAnnotationRulerNode"))
