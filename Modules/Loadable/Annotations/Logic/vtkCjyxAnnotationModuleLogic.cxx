...
//-----------------------------------------------------------------------------
void vtkCjyxAnnotationModuleLogic::ProcessMRMLNodesEvents(vtkObject *vtkNotUsed(caller),
                                                            unsigned long event,
                                                            void *callData)
{
...
//-----------------------------------------------------------------------------
void vtkCjyxAnnotationModuleLogic::OnMRMLSceneNodeAdded(vtkMRMLNode* node)
{
...
//-----------------------------------------------------------------------------
void vtkCjyxAnnotationModuleLogic::OnMRMLAnnotationNodeModifiedEvent(vtkMRMLNode* node)
{
...
//-----------------------------------------------------------------------------
void vtkCjyxAnnotationModuleLogic::OnMRMLSceneEndClose()
{
  if (this->m_LastAddedAnnotationNode)
    {
    this->m_LastAddedAnnotationNode = nullptr;
...
//---------------------------------------------------------------------------
void vtkCjyxAnnotationModuleLogic::SetMRMLSceneInternal(vtkMRMLScene * newScene)
{
...
//---------------------------------------------------------------------------
void vtkCjyxAnnotationModuleLogic::ObserveMRMLScene()
{
  ...
  if (selectionNode)
    ...
    if (selectionNode->PlaceNodeClassNameInList("vtkMRMLAnnotationRulerNode") < 0
      ...
      vtkDebugMacro("vtkCjyxAnnotationModuleLogic::ObserveMRMLScene(): adding new annotation class names to selection node place list");
...
//---------------------------------------------------------------------------
void vtkCjyxAnnotationModuleLogic::StartPlaceMode(bool persistent, vtkMRMLInteractionNode* interactionNode)
{
...
//---------------------------------------------------------------------------
void vtkCjyxAnnotationModuleLogic::AddNodeCompleted(vtkMRMLAnnotationNode* annotationNode)
{
...
// Exit the place mode
//---------------------------------------------------------------------------
void vtkCjyxAnnotationModuleLogic::StopPlaceMode(bool persistent, vtkMRMLInteractionNode* interactionNode)
{
...
//---------------------------------------------------------------------------
void vtkCjyxAnnotationModuleLogic::CancelCurrentOrRemoveLastAddedAnnotationNode(vtkMRMLInteractionNode* interactionNode)
{
  if (!interactionNode && this->GetMRMLScene())
    {
    interactionNode = vtkMRMLInteractionNode::SafeDownCast(this->GetMRMLScene()->GetNodeByID("vtkMRMLInteractionNodeSingleton"));
...
//---------------------------------------------------------------------------
void vtkCjyxAnnotationModuleLogic::RemoveAnnotationNode(vtkMRMLAnnotationNode* annotationNode)
{
  if (!annotationNode)
    {
...
//---------------------------------------------------------------------------
char * vtkCjyxAnnotationModuleLogic::GetTopLevelHierarchyNodeID(vtkMRMLNode* node)
{
  if (this->GetMRMLScene() == nullptr)
    {
    return nullptr;
...
//---------------------------------------------------------------------------
char * vtkCjyxAnnotationModuleLogic::GetTopLevelHierarchyNodeIDForNodeClass(vtkMRMLAnnotationNode *annotationNode)
{
  if (!annotationNode)
    {
    return nullptr;
  ...
  //---------------------------------------------------------------------------
  bool vtkCjyxAnnotationModuleLogic::AddHierarchyNodeForAnnotation(vtkMRMLAnnotationNode* annotationNode)
  {
...
//---------------------------------------------------------------------------
vtkMRMLAnnotationHierarchyNode *vtkCjyxAnnotationModuleLogic::GetActiveHierarchyNode()
{
  if (!this->GetActiveHierarchyNodeID())
    {
...
//---------------------------------------------------------------------------
void vtkCjyxAnnotationModuleLogic::SetHierarchyAnnotationsVisibleFlag(vtkMRMLAnnotationHierarchyNode* hierarchyNode, bool flag)
{
...
//---------------------------------------------------------------------------
void vtkCjyxAnnotationModuleLogic::SetHierarchyAnnotationsLockFlag(vtkMRMLAnnotationHierarchyNode* hierarchyNode, bool flag)
{
  if (hierarchyNode == nullptr)
    {
    // use the active one
...
//---------------------------------------------------------------------------
const char* vtkCjyxAnnotationModuleLogic::GetHTMLRepresentation(vtkMRMLAnnotationHierarchyNode* hierarchyNode, int level)
{
  if (!hierarchyNode)
    {
...
//---------------------------------------------------------------------------
const char* vtkCjyxAnnotationModuleLogic::GetHTMLRepresentation(vtkMRMLAnnotationNode* annotationNode, int level)
{
  if (!annotationNode)
    {
...
//---------------------------------------------------------------------------
vtkMRMLAnnotationTextDisplayNode *vtkCjyxAnnotationModuleLogic::GetTextDisplayNode(const char *id)
{
  if (!id)
    {
    return nullptr;
...
//---------------------------------------------------------------------------
vtkMRMLAnnotationPointDisplayNode *vtkCjyxAnnotationModuleLogic::GetPointDisplayNode(const char *id)
{
  if (!id)
    {
    return nullptr;
...
//---------------------------------------------------------------------------
vtkMRMLAnnotationLineDisplayNode *vtkCjyxAnnotationModuleLogic::GetLineDisplayNode(const char *id)
{
  if (!id)
    {
    return nullptr;
...
//---------------------------------------------------------------------------
const char * vtkCjyxAnnotationModuleLogic::AddDisplayNodeForHierarchyNode(vtkMRMLAnnotationHierarchyNode *hnode)
{
  if (!hnode)
    {
