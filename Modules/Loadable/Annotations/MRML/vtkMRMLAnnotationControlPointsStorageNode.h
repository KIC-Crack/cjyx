...
#include "vtkCjyxAnnotationsModuleMRMLExport.h"
...
class  VTK_CJYX_ANNOTATIONS_MODULE_MRML_EXPORT vtkMRMLAnnotationControlPointsStorageNode : public vtkMRMLAnnotationStorageNode
{
public:
