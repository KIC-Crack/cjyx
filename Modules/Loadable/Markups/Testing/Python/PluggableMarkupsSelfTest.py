...
class PluggableMarkupsSelfTestLogic(ScriptedLoadableModuleLogic):
    ...
    def setUp(self):
        ...
        #
        additionalOptionsWidgetsFactory = cjyx.qMRMLMarkupsOptionsWidgetsFactory().instance()
    ...
    def markupsNodes(self):
        return {
            cjyx.vtkMRMLMarkupsAngleNode(): cjyx.vtkCjyxAngleWidget(),
            cjyx.vtkMRMLMarkupsClosedCurveNode(): cjyx.vtkCjyxCurveWidget(),
            cjyx.vtkMRMLMarkupsCurveNode(): cjyx.vtkCjyxCurveWidget(),
            cjyx.vtkMRMLMarkupsFiducialNode(): cjyx.vtkCjyxPointsWidget(),
            cjyx.vtkMRMLMarkupsLineNode(): cjyx.vtkCjyxLineWidget(),
            cjyx.vtkMRMLMarkupsPlaneNode(): cjyx.vtkCjyxPlaneWidget(),
            cjyx.vtkMRMLMarkupsROINode(): cjyx.vtkCjyxROIWidget(),
            cjyx.vtkMRMLMarkupsTestLineNode(): cjyx.vtkCjyxTestLineWidget()
        }

    def additionalOptionsWidgets(self):
        return [
            cjyx.qMRMLMarkupsCurveSettingsWidget(),
            cjyx.qMRMLMarkupsAngleMeasurementsWidget(),
            cjyx.qMRMLMarkupsPlaneWidget(),
            cjyx.qMRMLMarkupsROIWidget(),
            cjyx.qMRMLMarkupsTestLineWidget()
        ]
