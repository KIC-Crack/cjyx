...
fidNode1 = cjyx.mrmlScene.AddNewNodeByClass("vtkMRMLMarkupsFiducialNode", "FidNode1")
...
fidNode2 = cjyx.mrmlScene.AddNewNodeByClass("vtkMRMLMarkupsFiducialNode", "FidNode2")
...
# Create scene view
numFidNodesBeforeStore = cjyx.mrmlScene.GetNumberOfNodesByClass('vtkMRMLMarkupsFiducialNode')
sv = cjyx.mrmlScene.AddNewNodeByClass("vtkMRMLSceneViewNode")
sv.StoreScene()

# add a third list that will get removed on restore
# second control point list
fidNode3 = cjyx.mrmlScene.AddNewNodeByClass("vtkMRMLMarkupsFiducialNode", "FidNode3")
...
numFidNodesAfterRestore = cjyx.mrmlScene.GetNumberOfNodesByClass('vtkMRMLMarkupsFiducialNode')
...
fid1AfterRestore = cjyx.mrmlScene.GetFirstNodeByName("FidNode1")
...
fid2AfterRestore = cjyx.mrmlScene.GetFirstNodeByName("FidNode2")
