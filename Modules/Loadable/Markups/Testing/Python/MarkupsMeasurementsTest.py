...
markupsNode = cjyx.mrmlScene.AddNewNodeByClass('vtkMRMLMarkupsLineNode')
length = 34.12
...
markupsNode = cjyx.mrmlScene.AddNewNodeByClass('vtkMRMLMarkupsAngleNode')
...
markupsNode = cjyx.mrmlScene.AddNewNodeByClass('vtkMRMLMarkupsPlaneNode')
markupsNode.SetPlaneType(cjyx.vtkMRMLMarkupsPlaneNode.PlaneType3Points)
markupsNode.AddControlPoint(vtk.vtkVector3d(30, -22.4, 13.8))
...
markupsNode = cjyx.mrmlScene.AddNewNodeByClass('vtkMRMLMarkupsROINode')
