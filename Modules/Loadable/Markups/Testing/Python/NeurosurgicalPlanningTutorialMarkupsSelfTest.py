...
class NeurosurgicalPlanningTutorialMarkupsSelfTestTest(ScriptedLoadableModuleTest):
    ...
    def test_NeurosurgicalPlanningTutorialMarkupsSelfTest1(self):
        ...
        # Create segmentation
        segmentationNode = cjyx.mrmlScene.AddNewNodeByClass("vtkMRMLSegmentationNode", baselineVolume.GetName() + '-segmentation')
        ...
        segmentEditorNode.SetOverwriteMode(cjyx.vtkMRMLSegmentEditorNode.OverwriteNone)
