...
//-----------------------------------------------------------------------------
qMRMLMarkupsToolBar* qCjyxMarkupsModuleWidgetPrivate::toolBar()
{
...
//-----------------------------------------------------------------------------
vtkMRMLSelectionNode* qCjyxMarkupsModuleWidgetPrivate::selectionNode()
{
  Q_Q(qCjyxMarkupsModuleWidget);
...
//-----------------------------------------------------------------------------
vtkMRMLMarkupsDisplayNode* qCjyxMarkupsModuleWidgetPrivate::markupsDisplayNode()
{
  Q_Q(qCjyxMarkupsModuleWidget);
  if (!this->MarkupsNode)
    {
...
//-----------------------------------------------------------------------------
vtkMRMLNode* qCjyxMarkupsModuleWidgetPrivate::selectionNodeActivePlaceNode()
{
  Q_Q(qCjyxMarkupsModuleWidget);
...
//-----------------------------------------------------------------------------
void qCjyxMarkupsModuleWidgetPrivate::setSelectionNodeActivePlaceNode(vtkMRMLNode* node)
{
  Q_Q(qCjyxMarkupsModuleWidget);
  if (!q->markupsLogic())
    {
...
//-----------------------------------------------------------------------------
void qCjyxMarkupsModuleWidgetPrivate::setMRMLMarkupsNodeFromSelectionNode()
{
  Q_Q(qCjyxMarkupsModuleWidget);
...
//-----------------------------------------------------------------------------
void qCjyxMarkupsModuleWidget::updateWidgetFromMRML()
  {
  Q_D(qCjyxMarkupsModuleWidget);
...
//-----------------------------------------------------------------------------
void qCjyxMarkupsModuleWidget::onMRMLSceneEndImportEvent()
{
  this->checkForAnnotationFiducialConversion();
...
//-----------------------------------------------------------------------------
void qCjyxMarkupsModuleWidget::onMRMLSceneEndRestoreEvent()
{
  this->checkForAnnotationFiducialConversion();
  this->updateWidgetFromMRML();
}
...
//-----------------------------------------------------------------------------
void qCjyxMarkupsModuleWidget::onMRMLSceneEndBatchProcessEvent()
{
  Q_D(qCjyxMarkupsModuleWidget);
  if (!this->mrmlScene())
    {
...
//-----------------------------------------------------------------------------
void qCjyxMarkupsModuleWidget::onMRMLSceneEndCloseEvent()
{
  if (!this->mrmlScene() || this->mrmlScene()->IsBatchProcessing())
    {
    return;
...
//-----------------------------------------------------------------------------
void qCjyxMarkupsModuleWidget::onActiveMarkupMRMLNodeAdded(vtkMRMLNode * node)
{
  Q_D(qCjyxMarkupsModuleWidget);
  if (this->markupsLogic())
    {
...
//-----------------------------------------------------------------------------
void qCjyxMarkupsModuleWidget::onActiveMarkupMRMLNodeChanged(vtkMRMLNode* node)
{
  Q_D(qCjyxMarkupsModuleWidget);
...
//-----------------------------------------------------------------------------
QStringList qCjyxMarkupsModuleWidget::getOtherMarkupNames(vtkMRMLNode *thisMarkup)
{
...
//-----------------------------------------------------------------------------
void qCjyxMarkupsModuleWidget::setMRMLMarkupsNode(vtkMRMLMarkupsNode* markupsNode)
{
  Q_D(qCjyxMarkupsModuleWidget);
...
//-----------------------------------------------------------------------------
vtkMRMLMarkupsNode* qCjyxMarkupsModuleWidget::mrmlMarkupsNode()
{
  Q_D(qCjyxMarkupsModuleWidget);
...
//-----------------------------------------------------------
bool qCjyxMarkupsModuleWidget::setEditedNode(vtkMRMLNode* node,
...
//-----------------------------------------------------------
double qCjyxMarkupsModuleWidget::nodeEditable(vtkMRMLNode* node)
{
...
// --------------------------------------------------------------------------
void qCjyxMarkupsModuleWidget::updateToolBar(vtkMRMLMarkupsNode* node)
{
  Q_D(qCjyxMarkupsModuleWidget);
  if (!this->mrmlScene() || this->mrmlScene()->IsBatchProcessing())
    {
