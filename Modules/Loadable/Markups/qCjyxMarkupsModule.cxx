...
VTK_MODULE_INIT(vtkCjyxMarkupsModuleMRMLDisplayableManager);
...
//-----------------------------------------------------------------------------
vtkMRMLAbstractLogic* qCjyxMarkupsModule::createLogic()
{
...
//-----------------------------------------------------------------------------
void qCjyxMarkupsModule::setMRMLScene(vtkMRMLScene* scene)
{
  Q_D(qCjyxMarkupsModule);
...
//-----------------------------------------------------------------------------
void qCjyxMarkupsModule::readDefaultMarkupsDisplaySettings(vtkMRMLMarkupsDisplayNode* markupsDisplayNode)
{
...
//-----------------------------------------------------------------------------
void qCjyxMarkupsModule::writeDefaultMarkupsDisplaySettings(vtkMRMLMarkupsDisplayNode* markupsDisplayNode)
{
  if (!markupsDisplayNode)
    {
    qCritical() << Q_FUNC_INFO << " failed: markupsDisplayNode is invalid";
...
//-----------------------------------------------------------------------------
qMRMLMarkupsToolBar* qCjyxMarkupsModule::toolBar()
{
  Q_D(qCjyxMarkupsModule);
  return d->ToolBar;
}
...
//-----------------------------------------------------------------------------
bool qCjyxMarkupsModule::showMarkups(vtkMRMLMarkupsNode* markupsNode)
{
