...
class MarkupsWidgetsSelfTestTest(ScriptedLoadableModuleTest):
    ...
    def section_CreateMarkups(self):
        ...
        self.markupsNode1 = cjyx.mrmlScene.GetNodeByID(self.markupsLogic.AddNewFiducialNode())
        self.markupsNode1.SetName(self.sampleMarkupsNodeName1)

        self.markupsNode2 = cjyx.mrmlScene.GetNodeByID(self.markupsLogic.AddNewFiducialNode())
    ...
    def section_SimpleMarkupsWidget(self):
        ...
        simpleMarkupsWidget.setMRMLScene(cjyx.mrmlScene)
        ...
        otherInteractionNode = cjyx.vtkMRMLInteractionNode()
        otherInteractionNode.SetSingletonOff()
        cjyx.mrmlScene.AddNode(otherInteractionNode)
