...
void qMRMLMarkupsToolBarPrivate::init()
{
  ...
  this->MarkupsNodeSelector->setMRMLScene(qCjyxApplication::application()->mrmlScene());
  ...
  q->setMRMLScene(qCjyxApplication::application()->mrmlScene());
}

// --------------------------------------------------------------------------
void qMRMLMarkupsToolBarPrivate::addSetModuleButton(vtkCjyxMarkupsLogic* markupsLogic, const QString& moduleName)
{
...
//---------------------------------------------------------------------------
void qMRMLMarkupsToolBar::setApplicationLogic(vtkCjyxApplicationLogic* appLogic)
{
  Q_D(qMRMLMarkupsToolBar);
...
void qMRMLMarkupsToolBar::initializeToolBarLayout()
{
  ...
  vtkCjyxMarkupsLogic* markupsLogic =
    vtkCjyxMarkupsLogic::SafeDownCast(d->MRMLAppLogic->GetModuleLogic("Markups"));
  if (!markupsLogic)
    {
  ...
  d->MarkupsPlaceWidget->setMRMLScene(qCjyxApplication::application()->mrmlScene());
