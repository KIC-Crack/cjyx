...
public:
  ...
  /// \param markupsWidget vtkCjyxWidget associated to the MRMLMarkups node registered.
  ...
  /// \return pointer to associated vtkCJyxMarkupsWidget or nullptr if the MRML node
