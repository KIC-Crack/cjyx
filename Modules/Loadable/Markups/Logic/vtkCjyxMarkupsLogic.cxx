...
//---------------------------------------------------------------------------
void vtkCjyxMarkupsLogic::ProcessMRMLNodesEvents(vtkObject *caller,
                                                   unsigned long event,
                                                   void *callData)
{
...
//---------------------------------------------------------------------------
void vtkCjyxMarkupsLogic::SetMRMLSceneInternal(vtkMRMLScene * newScene)
{
  vtkNew<vtkIntArray> events;
...
//---------------------------------------------------------------------------
void vtkCjyxMarkupsLogic::ObserveMRMLScene()
{
  if (this->GetMRMLScene())
    {
...
void vtkCjyxMarkupsLogic::UpdatePlaceNodeClassNamesInSelectionNode()
{
  ...
  for (const std::string& markupType : this->Internal->RegisteredMarkupsOrder)
    ...
    if (selectionNode->PlaceNodeClassNameInList(markupsClassName) < 0)
      ...
      if (!markupsNode)
        {
        vtkErrorMacro("vtkCjyxMarkupsLogic::ObserveMRMLScene: Failed to create markups node by class " << markupsClassName);
        continue;
        }
...
//---------------------------------------------------------------------------
void vtkCjyxMarkupsLogic::SetAndObserveSelectionNode(vtkMRMLSelectionNode* selectionNode)
{
...
//---------------------------------------------------------------------------
void vtkCjyxMarkupsLogic::UpdateFromMRMLScene()
{
  assert(this->GetMRMLScene() != nullptr);
}

//---------------------------------------------------------------------------
void vtkCjyxMarkupsLogic::OnMRMLSceneNodeAdded(vtkMRMLNode* node)
{
  if (!node)
    {
    return;
...
//---------------------------------------------------------------------------
void vtkCjyxMarkupsLogic::OnMRMLSceneNodeRemoved(vtkMRMLNode* node)
{
  // remove observer
  if (!node)
    {
...
//---------------------------------------------------------------------------
void vtkCjyxMarkupsLogic::SetActiveListID(vtkMRMLMarkupsNode* markupsNode)
{
  this->SetActiveList(markupsNode);
}

//---------------------------------------------------------------------------
void vtkCjyxMarkupsLogic::SetActiveList(vtkMRMLMarkupsNode *markupsNode)
{
  vtkMRMLSelectionNode *selectionNode = vtkMRMLSelectionNode::SafeDownCast(this->GetMRMLScene()->GetNodeByID(this->GetSelectionNodeID().c_str()));
  if (!selectionNode)
    {
...
//---------------------------------------------------------------------------
std::string vtkCjyxMarkupsLogic::AddNewDisplayNodeForMarkupsNode(vtkMRMLNode *mrmlNode)
{
  std::string id;
...
//---------------------------------------------------------------------------
std::string vtkCjyxMarkupsLogic::AddNewFiducialNode(const char *name, vtkMRMLScene *scene)
{
...
//---------------------------------------------------------------------------
vtkMRMLMarkupsNode* vtkCjyxMarkupsLogic::AddNewMarkupsNode(
...
//---------------------------------------------------------------------------
char* vtkCjyxMarkupsLogic::LoadMarkups(const char* fileName, const char* nodeName/*=nullptr*/, vtkMRMLMessageCollection* userMessages/*=nullptr*/)
{
  if (!fileName)
    {
...
//---------------------------------------------------------------------------
char* vtkCjyxMarkupsLogic::LoadMarkupsFiducials(const char* fileName, const char* fidsName/*=nullptr*/, vtkMRMLMessageCollection* userMessages/*=nullptr*/)
{
  return this->LoadMarkups(fileName, fidsName, userMessages);
}

//---------------------------------------------------------------------------
char* vtkCjyxMarkupsLogic::LoadMarkupsFromJson(const char* fileName, const char* nodeName/*=nullptr*/, vtkMRMLMessageCollection* userMessages/*=nullptr*/)
{
  if (!fileName)
    {
...
//---------------------------------------------------------------------------
char * vtkCjyxMarkupsLogic::LoadMarkupsFromFcsv(const char* fileName, const char* nodeName/*=nullptr*/, vtkMRMLMessageCollection* userMessages/*=nullptr*/)
{
  if (!fileName)
    {
    vtkErrorMacro("LoadMarkups: null file or markups class name, cannot load");
...
//---------------------------------------------------------------------------
void vtkCjyxMarkupsLogic::SetAllControlPointsVisibility(vtkMRMLMarkupsNode *node, bool flag)
{
  if (!node)
    {
...
//---------------------------------------------------------------------------
void vtkCjyxMarkupsLogic::ToggleAllControlPointsVisibility(vtkMRMLMarkupsNode *node)
{
  if (!node)
    {
...
//---------------------------------------------------------------------------
void vtkCjyxMarkupsLogic::SetAllControlPointsLocked(vtkMRMLMarkupsNode *node, bool flag)
{
  if (!node)
    {
...
//---------------------------------------------------------------------------
void vtkCjyxMarkupsLogic::ToggleAllControlPointsLocked(vtkMRMLMarkupsNode *node)
{
  if (!node)
    {
...
//---------------------------------------------------------------------------
void vtkCjyxMarkupsLogic::SetAllControlPointsSelected(vtkMRMLMarkupsNode *node, bool flag)
{
  if (!node)
    {
...
//---------------------------------------------------------------------------
void vtkCjyxMarkupsLogic::ToggleAllControlPointsSelected(vtkMRMLMarkupsNode *node)
{
  if (!node)
    {
...
//---------------------------------------------------------------------------
void vtkCjyxMarkupsLogic::CopyBasicDisplayProperties(vtkMRMLMarkupsDisplayNode *sourceDisplayNode,
...
//---------------------------------------------------------------------------
void vtkCjyxMarkupsLogic::SetDisplayNodeToDefaults(vtkMRMLMarkupsDisplayNode *displayNode)
{
  if (!displayNode)
    {
    return;
...
//---------------------------------------------------------------------------
void vtkCjyxMarkupsLogic::SetDisplayDefaultsFromNode(vtkMRMLMarkupsDisplayNode *displayNode)
{
  if (!displayNode)
    {
    return;
...
//---------------------------------------------------------------------------
bool vtkCjyxMarkupsLogic::MoveNthControlPointToNewListAtIndex(int n, vtkMRMLMarkupsNode *markupsNode,
...
//---------------------------------------------------------------------------
bool vtkCjyxMarkupsLogic::CopyNthControlPointToNewList(int n, vtkMRMLMarkupsNode *markupsNode,
...
//---------------------------------------------------------------------------
void vtkCjyxMarkupsLogic::RenameAllControlPointsFromCurrentFormat(vtkMRMLMarkupsNode *markupsNode)
{
  if (!markupsNode)
    {
    return;
...
//---------------------------------------------------------------------------
bool vtkCjyxMarkupsLogic::StartPlaceMode(bool persistent, vtkMRMLInteractionNode* interactionNode)
{
  if (!this->GetMRMLScene())
    {
...
//---------------------------------------------------------------------------
vtkMRMLMarkupsDisplayNode* vtkCjyxMarkupsLogic::GetDefaultMarkupsDisplayNode()
{
  if (!this->GetMRMLScene())
    {
    return nullptr;
...
//---------------------------------------------------------------------------
double vtkCjyxMarkupsLogic::GetClosedCurveSurfaceArea(vtkMRMLMarkupsClosedCurveNode* curveNode,
...
//---------------------------------------------------------------------------
bool vtkCjyxMarkupsLogic::GetBestFitPlane(vtkMRMLMarkupsNode* curveNode, vtkPlane* plane)
{
  if (!curveNode || !plane)
    {
    return false;
...
//---------------------------------------------------------------------------
vtkMRMLMarkupsJsonStorageNode* vtkCjyxMarkupsLogic::AddNewJsonStorageNodeForMarkupsType(std::string markupsType)
{
...
//---------------------------------------------------------------------------
void vtkCjyxMarkupsLogic::RegisterMarkupsNode(vtkMRMLMarkupsNode* markupsNode,
...
//---------------------------------------------------------------------------
void vtkCjyxMarkupsLogic::UnregisterMarkupsNode(vtkMRMLMarkupsNode* markupsNode)
{
  // Check for nullptr
  if (markupsNode == nullptr)
    {
...
//----------------------------------------------------------------------------
vtkMRMLMarkupsNode* vtkCjyxMarkupsLogic::GetNodeByMarkupsType(const char* markupName) const
{
  if (!markupName)
    {
...
//----------------------------------------------------------------------------
bool vtkCjyxMarkupsLogic::ImportControlPointsFromTable(vtkMRMLMarkupsNode* markupsNode, vtkMRMLTableNode* tableNode,
...
//----------------------------------------------------------------------------
bool vtkCjyxMarkupsLogic::ExportControlPointsToTable(vtkMRMLMarkupsNode* markupsNode, vtkMRMLTableNode* tableNode,
...
//------------------------------------------------------------------------------
bool vtkCjyxMarkupsLogic::ExportControlPointsToCSV(vtkMRMLMarkupsNode* markupsNode,
