...
#include "vtkCjyxMarkupsModuleMRMLExport.h" // For export macro

#include <vtkParametricFunction.h>
#include <vtkSmartPointer.h>

class VTK_CJYX_MARKUPS_MODULE_MRML_EXPORT vtkParametricPolynomialApproximation : public vtkParametricFunction
{
public:
