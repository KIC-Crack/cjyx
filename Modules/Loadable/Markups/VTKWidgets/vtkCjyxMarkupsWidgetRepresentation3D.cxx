...
//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation3D::UpdateNthPointAndLabelFromMRML(int vtkNotUsed(n))
{
  /*
...
//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation3D::UpdateAllPointsAndLabelsFromMRML()
{
...
//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation3D::UpdateFromMRML(vtkMRMLNode* caller, unsigned long event, void *callData /*=nullptr*/)
{
...
//----------------------------------------------------------------------
double vtkCjyxMarkupsWidgetRepresentation3D::GetViewScaleFactorAtPosition(double positionWorld[3], vtkMRMLInteractionEventData* interactionEventData)
{
