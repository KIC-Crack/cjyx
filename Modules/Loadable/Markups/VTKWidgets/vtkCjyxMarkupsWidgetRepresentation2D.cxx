...
//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation2D::UpdateAllPointsAndLabelsFromMRML(double labelsOffset)
{
...
//----------------------------------------------------------------------
vtkMRMLSliceNode *vtkCjyxMarkupsWidgetRepresentation2D::GetSliceNode()
{
...
//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation2D::UpdateFromMRML(vtkMRMLNode* caller, unsigned long event, void *callData/*=nullptr*/)
{
...
//---------------------------------------------------------------------------
bool vtkCjyxMarkupsWidgetRepresentation2D::IsControlPointDisplayableOnSlice(vtkMRMLMarkupsNode *markupsNode, int pointIndex)
{
  vtkMRMLSliceNode *sliceNode = this->GetSliceNode();
  if (!sliceNode)
    {
...
//---------------------------------------------------------------------------
bool vtkCjyxMarkupsWidgetRepresentation2D::IsPointBehindSlice(vtkMRMLMarkupsNode *markupsNode, int pointIndex)
{
  vtkMRMLSliceNode *sliceNode = this->GetSliceNode();
  if (!sliceNode)
    {
...
//---------------------------------------------------------------------------
bool vtkCjyxMarkupsWidgetRepresentation2D::IsPointInFrontSlice(vtkMRMLMarkupsNode *markupsNode, int pointIndex)
{
  vtkMRMLSliceNode *sliceNode = this->GetSliceNode();
  if (!sliceNode)
    {
...
//---------------------------------------------------------------------------
bool vtkCjyxMarkupsWidgetRepresentation2D::IsCenterDisplayableOnSlice(vtkMRMLMarkupsNode *markupsNode)
{
