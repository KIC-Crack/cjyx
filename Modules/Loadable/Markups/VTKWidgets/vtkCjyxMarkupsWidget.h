 ...
 *
 * @sa
 * vtkMRMLAbstractWidget vtkCjyxWidgetRepresentation vtkCjyxWidgetEventTranslator
 *
*/
...
class VTK_CJYX_MARKUPS_MODULE_VTKWIDGETS_EXPORT vtkCjyxMarkupsWidget : public vtkMRMLAbstractWidget
{
public:
  /// Standard methods for a VTK class.
  vtkTypeMacro(vtkCjyxMarkupsWidget, vtkMRMLAbstractWidget);
