...
*
 * @sa
 * vtkCjyxMarkupsWidgetRepresentation vtkMRMLAbstractWidget vtkPointPlacer
*/
...
class VTK_CJYX_MARKUPS_MODULE_VTKWIDGETS_EXPORT vtkCjyxMarkupsWidgetRepresentation : public vtkMRMLAbstractWidgetRepresentation
{
public:
  enum
  {
  ...
  vtkTypeMacro(vtkCjyxMarkupsWidgetRepresentation, vtkMRMLAbstractWidgetRepresentation);
