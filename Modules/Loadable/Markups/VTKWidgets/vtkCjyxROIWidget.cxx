...
//-----------------------------------------------------------------------------
bool vtkCjyxROIWidget::CanProcessInteractionEvent(vtkMRMLInteractionEventData* eventData, double &distance2)
{
...
//-----------------------------------------------------------------------------
bool vtkCjyxROIWidget::ProcessInteractionEvent(vtkMRMLInteractionEventData* eventData)
{
  unsigned long widgetEvent = this->TranslateInteractionEventToWidgetEvent(eventData);
...
//-------------------------------------------------------------------------
bool vtkCjyxROIWidget::ProcessWidgetSymmetricScaleStart(vtkMRMLInteractionEventData* eventData)
{
...
//-------------------------------------------------------------------------
bool vtkCjyxROIWidget::ProcessEndMouseDrag(vtkMRMLInteractionEventData* eventData)
{
  if (!this->WidgetRep)
    {
    return false;
...
//-------------------------------------------------------------------------
bool vtkCjyxROIWidget::ProcessMouseMove(vtkMRMLInteractionEventData* eventData)
{
