...
#include "vtkCjyxMarkupsModuleMRMLDisplayableManagerExport.h"
...
class VTK_CJYX_MARKUPS_MODULE_MRMLDISPLAYABLEMANAGER_EXPORT vtkMRMLMarkupsDisplayableManagerHelper :
    public vtkObject
{
public:
  ...
  vtkCjyxMarkupsWidget * GetWidget(vtkMRMLMarkupsDisplayNode * markupsDisplayNode);
  /// Get first visible widget for this markup
  vtkCjyxMarkupsWidget * GetWidget(vtkMRMLMarkupsNode * markupsNode);

  /// Remove all widgets, intersection widgets, nodes
  void RemoveAllWidgetsAndNodes();

  /// Map of vtkWidget indexed using associated node ID
  typedef std::map < vtkSmartPointer<vtkMRMLMarkupsDisplayNode>, vtkCjyxMarkupsWidget* > DisplayNodeToWidgetType;
  typedef std::map < vtkSmartPointer<vtkMRMLMarkupsDisplayNode>, vtkCjyxMarkupsWidget* >::iterator DisplayNodeToWidgetIt;
