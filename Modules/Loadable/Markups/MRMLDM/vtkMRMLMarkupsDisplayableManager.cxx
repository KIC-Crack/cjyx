...
//---------------------------------------------------------------------------
vtkCjyxMarkupsWidget* vtkMRMLMarkupsDisplayableManager::GetWidget(vtkMRMLMarkupsDisplayNode * node)
{
...
bool vtkMRMLMarkupsDisplayableManager::IsManageable(const char* nodeClassName)
{
  ...
  vtkCjyxMarkupsLogic* markupsLogic =
    vtkCjyxMarkupsLogic::SafeDownCast(this->GetMRMLApplicationLogic()->GetModuleLogic("Markups"));
  if (!markupsLogic)
    {
...
//---------------------------------------------------------------------------
vtkCjyxMarkupsWidget* vtkMRMLMarkupsDisplayableManager::FindClosestWidget(vtkMRMLInteractionEventData *callData, double &closestDistance2)
{
...
//---------------------------------------------------------------------------
vtkCjyxMarkupsWidget* vtkMRMLMarkupsDisplayableManager::GetWidgetForPlacement()
{
...
//---------------------------------------------------------------------------
vtkCjyxMarkupsWidget * vtkMRMLMarkupsDisplayableManager::CreateWidget(vtkMRMLMarkupsDisplayNode* markupsDisplayNode)
{
