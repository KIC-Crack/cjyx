...
class  VTK_CJYX_MARKUPS_MODULE_MRMLDISPLAYABLEMANAGER_EXPORT vtkMRMLMarkupsDisplayableManager :
...
public:
  ...
  vtkCjyxMarkupsWidget* GetWidget(vtkMRMLMarkupsDisplayNode * node);
...
protected:
  ...
  vtkCjyxMarkupsWidget* FindClosestWidget(vtkMRMLInteractionEventData *callData, double &closestDistance2);
  ...
  /// Create a widget.
  vtkCjyxMarkupsWidget* CreateWidget(vtkMRMLMarkupsDisplayNode* node);
