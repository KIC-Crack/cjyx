...
qCjyxMarkupsWriter::qCjyxMarkupsWriter(QObject* parentObject)
  : qCjyxNodeWriter("Markups", QString("MarkupsFile"), QStringList() << "vtkMRMLMarkupsNode", true, parentObject)
{
}
...
//----------------------------------------------------------------------------
void qCjyxMarkupsWriter::setStorageNodeClass(vtkMRMLStorableNode* storableNode, const QString& storageNodeClassName)
{
  if (!storableNode)
    {
