...
//----------------------------------------------------------------------------
int vtkCjyxCropVolumeLogic::Apply(vtkMRMLCropVolumeParametersNode* pnode)
{
...
//----------------------------------------------------------------------------
bool vtkCjyxCropVolumeLogic::GetVoxelBasedCropOutputExtent(vtkMRMLDisplayableNode* roi, vtkMRMLVolumeNode* inputVolume,
...
//----------------------------------------------------------------------------
int vtkCjyxCropVolumeLogic::CropVoxelBased(vtkMRMLDisplayableNode* roi,
...
//----------------------------------------------------------------------------
bool vtkCjyxCropVolumeLogic::GetInterpolatedCropOutputGeometry(vtkMRMLDisplayableNode* roi, vtkMRMLVolumeNode* inputVolume,
...
//----------------------------------------------------------------------------
int vtkCjyxCropVolumeLogic::CropInterpolated(vtkMRMLDisplayableNode* roi, vtkMRMLVolumeNode* inputVolume, vtkMRMLVolumeNode* outputVolume,
...
//-----------------------------------------------------------------------------
bool vtkCjyxCropVolumeLogic::FitROIToInputVolume(vtkMRMLCropVolumeParametersNode* parametersNode)
{
  if (!parametersNode)
    {
    return false;
...
//----------------------------------------------------------------------------
void vtkCjyxCropVolumeLogic::SnapROIToVoxelGrid(vtkMRMLCropVolumeParametersNode* parametersNode)
{
...
//----------------------------------------------------------------------------
bool vtkCjyxCropVolumeLogic::IsROIAlignedWithInputVolume(vtkMRMLCropVolumeParametersNode* parametersNode)
{
  if (!parametersNode || !parametersNode->GetInputVolumeNode() || !parametersNode->GetROINode())
    {
    // no misalignment (not enough nodes to be misaligned)
