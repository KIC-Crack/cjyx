...
//-----------------------------------------------------------------------------
void qCjyxCropVolumeModuleWidget::setMRMLScene(vtkMRMLScene* scene)
{
...
//-----------------------------------------------------------------------------
void qCjyxCropVolumeModuleWidget::initializeInputROI(vtkMRMLNode *roiNode)
{
...
//-----------------------------------------------------------------------------
void qCjyxCropVolumeModuleWidget::setInputVolume(vtkMRMLNode* volumeNode)
{
  Q_D(qCjyxCropVolumeModuleWidget);
...
//-----------------------------------------------------------------------------
void qCjyxCropVolumeModuleWidget::setOutputVolume(vtkMRMLNode* volumeNode)
{
  Q_D(qCjyxCropVolumeModuleWidget);
...
//-----------------------------------------------------------------------------
void qCjyxCropVolumeModuleWidget::setInputROI(vtkMRMLNode* node)
{
  Q_D(qCjyxCropVolumeModuleWidget);
...
//-----------------------------------------------------------------------------
void qCjyxCropVolumeModuleWidget::onInputROIAdded(vtkMRMLNode* node)
{
  Q_D(qCjyxCropVolumeModuleWidget);
...
//-----------------------------------------------------------------------------
void qCjyxCropVolumeModuleWidget::onMRMLSceneEndBatchProcessEvent()
{
...
//-----------------------------------------------------------------------------
void qCjyxCropVolumeModuleWidget::updateWidgetFromMRML()
{
  Q_D(qCjyxCropVolumeModuleWidget);
  if (!this->mrmlScene())
    {
...
//-----------------------------------------------------------
bool qCjyxCropVolumeModuleWidget::setEditedNode(vtkMRMLNode* node,
...
//------------------------------------------------------------------------------
void qCjyxCropVolumeModuleWidget::setParametersNode(vtkMRMLNode* node)
{
