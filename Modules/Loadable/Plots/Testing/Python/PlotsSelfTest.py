...
class PlotsSelfTestTest(ScriptedLoadableModuleTest):
    ...
    def section_CreateTable(self):
        ...
        tableNode = cjyx.mrmlScene.AddNewNodeByClass("vtkMRMLTableNode", self.tableName)
    ...
    def section_CreatePlots(self):
        ...
        plotSeriesNode1 = cjyx.mrmlScene.AddNewNodeByClass("vtkMRMLPlotSeriesNode", self.series1Name)
        ...
        plotSeriesNode1.SetLineStyle(cjyx.vtkMRMLPlotSeriesNode.LineStyleDash)
        plotSeriesNode1.SetMarkerStyle(cjyx.vtkMRMLPlotSeriesNode.MarkerStyleSquare)

        plotSeriesNode2 = cjyx.mrmlScene.AddNewNodeByClass("vtkMRMLPlotSeriesNode", self.series2Name)
        ...
        plotChartNode = cjyx.mrmlScene.AddNewNodeByClass("vtkMRMLPlotChartNode", self.chartName)
    ...
    def section_TestPlotView(self):
        ...
        plotViewNode = cjyx.mrmlScene.AddNewNodeByClass("vtkMRMLPlotViewNode")
        plotViewNode.SetPlotChartNodeID(plotChartNode.GetID())

        # Create plotWidget
        plotWidget = cjyx.qMRMLPlotWidget()
        plotWidget.setMRMLScene(cjyx.mrmlScene)
        plotWidget.setMRMLPlotViewNode(plotViewNode)
        plotWidget.show()

        # Create plotView
        plotView = cjyx.qMRMLPlotView()
        plotView.setMRMLScene(cjyx.mrmlScene)
