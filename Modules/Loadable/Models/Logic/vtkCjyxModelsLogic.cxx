...
//----------------------------------------------------------------------------
void vtkCjyxModelsLogic::SetMRMLSceneInternal(vtkMRMLScene* newScene)
{
...
//----------------------------------------------------------------------------
void vtkCjyxModelsLogic::ObserveMRMLScene()
{
...
//-----------------------------------------------------------------------------
void vtkCjyxModelsLogic::OnMRMLSceneEndImport()
{
...
//----------------------------------------------------------------------------
vtkMRMLModelNode* vtkCjyxModelsLogic::AddModel(vtkPolyData* polyData)
{
...
//----------------------------------------------------------------------------
vtkMRMLModelNode* vtkCjyxModelsLogic::AddModel(vtkAlgorithmOutput* polyData)
{
  if (this->GetMRMLScene() == nullptr)
    {
    return nullptr;
...
//----------------------------------------------------------------------------
vtkMRMLModelNode* vtkCjyxModelsLogic::AddModel(const char* filename,
  int coordinateSystem/*=vtkMRMLStorageNode::CoordinateSystemLPS*/,
  vtkMRMLMessageCollection* userMessages/*=nullptr*/)
{
...
//----------------------------------------------------------------------------
int vtkCjyxModelsLogic::SaveModel (const char* filename, vtkMRMLModelNode *modelNode,
...
//----------------------------------------------------------------------------
void vtkCjyxModelsLogic::TransformModel(vtkMRMLTransformNode *tnode,
