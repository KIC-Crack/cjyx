...
class ColorLegendSelfTestTest(ScriptedLoadableModuleTest):
    ...
    def test_ColorLegendSelfTest1(self):
        ...
        for ind, n in enumerate(testedColorNodeIndices):
            colorNode = cjyx.mrmlScene.GetNthNodeByClass(n, 'vtkMRMLColorNode')
        ...
        sliceNodeRed = cjyx.app.layoutManager().sliceWidget('Red').mrmlSliceNode()
        self.assertIsNotNone(sliceNodeRed)
        threeDViewNode = cjyx.app.layoutManager().threeDWidget(0).mrmlViewNode()
        ...
        for sliceName, titleColor in sliceNameColor.items():
            ...
            sliceNode = cjyx.app.layoutManager().sliceWidget(sliceName).mrmlSliceNode()
