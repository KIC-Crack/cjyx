...
colorNode = cjyx.vtkMRMLColorTableNode()
...
colorStorageNode = cjyx.vtkMRMLColorTableStorageNode()
colorStorageNode.SetFileName(filePath)
cjyx.mrmlScene.AddNode(colorStorageNode)
...
url = cjyx.app.temporaryPath + "/customColorTableSceneViewRestore.mrml"
cjyx.mrmlScene.SetURL(url)
cjyx.mrmlScene.Commit()
print("Saved to ", url)
