...
//----------------------------------------------------------------------------
vtkMRMLColorLegendDisplayNode* vtkCjyxColorLogic::AddDefaultColorLegendDisplayNode(vtkMRMLDisplayableNode* displayableNode)
{
  vtkMRMLDisplayNode* displayNode = vtkCjyxColorLogic::GetFirstNonColorLegendDisplayNode(displayableNode);
  if (!displayNode)
    {
...
//----------------------------------------------------------------------------
vtkMRMLColorLegendDisplayNode* vtkCjyxColorLogic::AddDefaultColorLegendDisplayNode(vtkMRMLDisplayNode* displayNode)
{
  if (!displayNode)
    {
  ...
  if (!mrmlScene)
    {
    vtkErrorWithObjectMacro(displayNode, "vtkCjyxColorLogic::AddDefaultColorLegendDisplayNode: Invalid MRML scene");
    return nullptr;
    }
  ...
  if (!colorLegendNode)
    {
    vtkErrorWithObjectMacro(displayNode, "vtkCjyxColorLogic::AddDefaultColorLegendDisplayNode: Failed to create vtkMRMLColorLegendDisplayNode");
    return nullptr;
    }
...
//----------------------------------------------------------------------------
vtkMRMLColorLegendDisplayNode* vtkCjyxColorLogic::GetNthColorLegendDisplayNode(
...
//----------------------------------------------------------------------------
int vtkCjyxColorLogic::GetNumberOfColorLegendDisplayNodes(vtkMRMLDisplayableNode* displayableNode)
{
  if (!displayableNode)
   {
...
//------------------------------------------------------------------------------
vtkMRMLColorLegendDisplayNode* vtkCjyxColorLogic::GetColorLegendDisplayNode(vtkMRMLDisplayableNode* displayableNode)
{
  vtkMRMLDisplayNode* displayNode = vtkCjyxColorLogic::GetFirstNonColorLegendDisplayNode(displayableNode);
...
//------------------------------------------------------------------------------
vtkMRMLColorLegendDisplayNode* vtkCjyxColorLogic::GetColorLegendDisplayNode(vtkMRMLDisplayNode* displayNode)
{
  if (!displayNode)
    {
    return nullptr;
...
//------------------------------------------------------------------------------
vtkMRMLDisplayNode* vtkCjyxColorLogic::GetFirstNonColorLegendDisplayNode(
