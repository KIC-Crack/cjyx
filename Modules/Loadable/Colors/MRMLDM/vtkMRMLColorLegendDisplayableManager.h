...
#include "vtkCjyxColorsModuleMRMLDisplayableManagerExport.h"
...
class VTK_CJYX_COLORS_MODULE_MRMLDISPLAYABLEMANAGER_EXPORT vtkMRMLColorLegendDisplayableManager :
...
public:
  ...
  vtkCjyxScalarBarActor* GetColorLegendActor(vtkMRMLColorLegendDisplayNode* dispNode) const;
