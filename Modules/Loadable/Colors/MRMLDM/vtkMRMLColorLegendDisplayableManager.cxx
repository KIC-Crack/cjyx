...
//---------------------------------------------------------------------------
bool vtkMRMLColorLegendDisplayableManager::vtkInternal::ShowActor(vtkCjyxScalarBarActor* actor, bool show)
{
...
//---------------------------------------------------------------------------
vtkCjyxScalarBarActor* vtkMRMLColorLegendDisplayableManager::GetColorLegendActor(vtkMRMLColorLegendDisplayNode* dispNode) const
{
  if (!dispNode)
    {
