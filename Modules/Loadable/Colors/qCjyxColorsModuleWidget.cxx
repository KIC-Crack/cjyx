...
//-----------------------------------------------------------------------------
void qCjyxColorsModuleWidget::setMRMLScene(vtkMRMLScene *scene)
{
  Q_D(qCjyxColorsModuleWidget);
  this->qCjyxAbstractModuleWidget::setMRMLScene(scene);
  d->setDefaultColorNode();
}

//-----------------------------------------------------------------------------
void qCjyxColorsModuleWidget::setCurrentColorNode(vtkMRMLNode* colorNode)
{
  Q_D(qCjyxColorsModuleWidget);
...
//-----------------------------------------------------------------------------
void qCjyxColorsModuleWidget::onMRMLColorNodeChanged(vtkMRMLNode* newColorNode)
{
  Q_D(qCjyxColorsModuleWidget);
...
//-----------------------------------------------------------
void qCjyxColorsModuleWidget::onDisplayableNodeChanged(vtkMRMLNode* node)
{
  Q_D(qCjyxColorsModuleWidget);
...
//-----------------------------------------------------------
void qCjyxColorsModuleWidget::updateColorLegendFromMRML()
{
  Q_D(qCjyxColorsModuleWidget);
...
//-----------------------------------------------------------
bool qCjyxColorsModuleWidget::setEditedNode(vtkMRMLNode* node,
