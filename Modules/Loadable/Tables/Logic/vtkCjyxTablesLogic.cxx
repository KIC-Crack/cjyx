...
//----------------------------------------------------------------------------
vtkMRMLTableNode* vtkCjyxTablesLogic
...
int vtkCjyxTablesLogic::GetLayoutWithTable(int currentLayout)
{
  switch (currentLayout)
    ...
    case vtkMRMLLayoutNode::CjyxLayout3DTableView:
    case vtkMRMLLayoutNode::CjyxLayoutFourUpPlotTableView:
      // table already shown, no need to change
      return currentLayout;
    case vtkMRMLLayoutNode::CjyxLayoutOneUp3DView:
      return vtkMRMLLayoutNode::CjyxLayout3DTableView;
    ...
    default:
      return vtkMRMLLayoutNode::CjyxLayoutFourUpTableView;
    }
}
