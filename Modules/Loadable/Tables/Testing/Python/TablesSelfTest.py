...
class TablesSelfTestTest(ScriptedLoadableModuleTest):
    ...
    def section_CreateTable(self):
        ...
        tableNode = cjyx.vtkMRMLTableNode()
        cjyx.mrmlScene.AddNode(tableNode)
    ...
    def section_CliTableInputOutput(self):
        ...
        inputTableNode = cjyx.vtkMRMLTableNode()
        cjyx.mrmlScene.AddNode(inputTableNode)
        ...
        outputTableNode = cjyx.vtkMRMLTableNode()
        cjyx.mrmlScene.AddNode(outputTableNode)
    ...
    def createDummyTransform(self):
        transformNode = cjyx.vtkMRMLLinearTransformNode()
    ...
    def createDummyVolume(self):
        ...
        volumeNode = cjyx.vtkMRMLScalarVolumeNode()
        volumeNode.SetAndObserveImageData(imageData)
        displayNode = cjyx.vtkMRMLScalarVolumeDisplayNode()
        cjyx.mrmlScene.AddNode(volumeNode)
