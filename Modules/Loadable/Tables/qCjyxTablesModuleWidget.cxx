...
//-----------------------------------------------------------------------------
void qCjyxTablesModuleWidget::onNodeSelected(vtkMRMLNode* node)
{
  Q_D(qCjyxTablesModuleWidget);
...
//-----------------------------------------------------------------------------
void qCjyxTablesModuleWidget::onMRMLTableNodeModified(vtkObject* caller)
{
  Q_D(qCjyxTablesModuleWidget);
...
//-----------------------------------------------------------------------------
void qCjyxTablesModuleWidget::setCurrentTableNode(vtkMRMLNode* tableNode)
{
  Q_D(qCjyxTablesModuleWidget);
...
//-----------------------------------------------------------
bool qCjyxTablesModuleWidget::setEditedNode(vtkMRMLNode* node,
