...
class AddStorableDataAfterSceneViewTestTest(ScriptedLoadableModuleTest):
    ...
    def test_AddStorableDataAfterSceneViewTest1(self):
        ...
        pointList = cjyx.mrmlScene.AddNewNodeByClass('vtkMRMLMarkupsFiducialNode')
        ...
        #
        restoredData = cjyx.mrmlScene.GetNodeByID(mrHeadID)
        ...
        print('Scene error code = ' + str(cjyx.mrmlScene.GetErrorCode()))
        print('\t' + cjyx.mrmlScene.GetErrorMessage())
