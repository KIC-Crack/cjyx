...
//-----------------------------------------------------------------------------
QList<vtkSmartPointer<vtkMRMLTransformableNode> > qCjyxTransformsModuleWidgetPrivate::getSelectedNodes(qMRMLTreeView* tree)
{
...
//-----------------------------------------------------------------------------
void qCjyxTransformsModuleWidget::onNodeSelected(vtkMRMLNode* node)
{
  Q_D(qCjyxTransformsModuleWidget);
...
//-----------------------------------------------------------------------------
void qCjyxTransformsModuleWidget::onMRMLTransformNodeModified(vtkObject* caller)
{
  Q_D(qCjyxTransformsModuleWidget);
...
//-----------------------------------------------------------------------------
void qCjyxTransformsModuleWidget::setMRMLScene(vtkMRMLScene* scene)
{
  Q_D(qCjyxTransformsModuleWidget);
...
void qCjyxTransformsModuleWidget::convert()
{
  ...
  if (d->MRMLTransformNode == nullptr)
    {
    qWarning("qCjyxTransformsModuleWidget::convert failed: MRMLTransformNode is invalid");
    return;
    }
...
//-----------------------------------------------------------
bool qCjyxTransformsModuleWidget::setEditedNode(vtkMRMLNode* node,
