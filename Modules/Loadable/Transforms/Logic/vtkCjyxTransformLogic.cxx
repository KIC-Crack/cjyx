...
//-----------------------------------------------------------------------------
bool vtkCjyxTransformLogic::hardenTransform(vtkMRMLTransformableNode* transformableNode)
{
...
//----------------------------------------------------------------------------
vtkMRMLTransformNode* vtkCjyxTransformLogic::AddTransform(const char* filename, vtkMRMLScene *scene)
{
...
//----------------------------------------------------------------------------
void vtkCjyxTransformLogic::GetTransformedPointSamplesOnSlice(vtkPointSet* outputPointSet, vtkMRMLTransformNode* inputTransformNode,
...
//----------------------------------------------------------------------------
vtkMRMLVolumeNode* vtkCjyxTransformLogic::CreateDisplacementVolumeFromTransform(vtkMRMLTransformNode* inputTransformNode,
...
//----------------------------------------------------------------------------
vtkMRMLTransformNode* vtkCjyxTransformLogic::ConvertToGridTransform(vtkMRMLTransformNode* inputTransformNode,
...
//----------------------------------------------------------------------------
int vtkCjyxTransformLogic::GetGridSubdivision(vtkMRMLTransformDisplayNode* displayNode)
{
...
//----------------------------------------------------------------------------
void vtkCjyxTransformLogic::GetGridVisualization3d(vtkPolyData* output, vtkMRMLTransformDisplayNode* displayNode, vtkMatrix4x4* roiToRAS, int* roiSize)
{
  double pointSpacing = displayNode->GetGridSpacingMm() / GetGridSubdivision(displayNode);
  int numGridPoints[3] = { 0 };
...
//----------------------------------------------------------------------------
void vtkCjyxTransformLogic::GetContourVisualization3d(vtkPolyData* output, vtkMRMLTransformDisplayNode* displayNode, vtkMatrix4x4* roiToRAS, int* roiSize)
{
...
//----------------------------------------------------------------------------
bool vtkCjyxTransformLogic::GetVisualization2d(vtkPolyData* output, vtkMRMLTransformDisplayNode* displayNode,
...
//----------------------------------------------------------------------------
bool vtkCjyxTransformLogic::GetVisualization3d(vtkPolyData* output, vtkMRMLTransformDisplayNode* displayNode, vtkMRMLNode* regionNode)
{
...
//----------------------------------------------------------------------------
bool vtkCjyxTransformLogic::GetVisualization3d(vtkPolyData* output, vtkMRMLTransformDisplayNode* displayNode,
...
//----------------------------------------------------------------------------
vtkCjyxTransformLogic::TransformKind vtkCjyxTransformLogic::GetTransformKind(vtkMRMLTransformNode *transformNode)
{
...
//----------------------------------------------------------------------------
void vtkCjyxTransformLogic::GetMarkupsAsPoints(vtkMRMLMarkupsNode* markupsNode, vtkPoints* samplePoints_RAS)
{
