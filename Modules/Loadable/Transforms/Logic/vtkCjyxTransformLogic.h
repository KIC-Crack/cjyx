...
class VTK_CJYX_TRANSFORMS_MODULE_LOGIC_EXPORT vtkCjyxTransformLogic : public vtkMRMLAbstractLogic
{
  public:

  /// The Usual vtk class functions
  static vtkCjyxTransformLogic *New();
  vtkTypeMacro(vtkCjyxTransformLogic,vtkMRMLAbstractLogic);
