...
//----------------------------------------------------------------------------
void qCjyxSubjectHierarchyPluginHandler::observeSubjectHierarchyNode(vtkMRMLSubjectHierarchyNode* shNode)
{
  if (m_MRMLScene != nullptr)
  {
...
//-----------------------------------------------------------------------------
vtkMRMLSubjectHierarchyNode* qCjyxSubjectHierarchyPluginHandler::subjectHierarchyNode()const
{
  return m_MRMLScene == nullptr ? nullptr : m_MRMLScene->GetSubjectHierarchyNode();
}

//-----------------------------------------------------------------------------
void qCjyxSubjectHierarchyPluginHandler::setMRMLScene(vtkMRMLScene* scene)
{
...
//-----------------------------------------------------------------------------
vtkMRMLScene* qCjyxSubjectHierarchyPluginHandler::mrmlScene()const
{
  return m_MRMLScene;
}
...
//-----------------------------------------------------------------------------
void qCjyxSubjectHierarchyPluginHandler::showItemsInView(vtkIdList* itemIDsToShow, vtkMRMLAbstractViewNode* viewNode)
{
  if (!itemIDsToShow)
    {
    return;
