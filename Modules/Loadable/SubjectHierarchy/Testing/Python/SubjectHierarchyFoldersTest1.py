...
class SubjectHierarchyFoldersTest1(unittest.TestCase):
    ...
    def TestSection_InitializeTest(self):
        ...
        self.shNode = cjyx.vtkMRMLSubjectHierarchyNode.GetSubjectHierarchyNode(cjyx.mrmlScene)
        ...
        self.viewOwnerNode = cjyx.mrmlScene.AddNewNodeByClass("vtkMRMLScriptedModuleNode")
        self.viewNode = cjyx.vtkMRMLViewNode()
        ...
        self.viewNode = cjyx.mrmlScene.AddNode(self.viewNode)
        self.viewWidget = cjyx.qMRMLThreeDWidget()
        self.viewWidget.setMRMLScene(cjyx.mrmlScene)
    ...
    def TestSection_LoadTestData(self):
        ...
        self.assertEqual(298, cjyx.mrmlScene.GetNumberOfNodesByClass('vtkMRMLModelNode'))  # 301 with main window due to the slice views

        # Check number of model hierarchy nodes to make sure all of them were converted
        self.assertEqual(0, cjyx.mrmlScene.GetNumberOfNodesByClass('vtkMRMLModelHierarchyNode'))
        # Check number of folder display nodes, which is zero until branch display related functions are used
        self.assertEqual(0, cjyx.mrmlScene.GetNumberOfNodesByClass('vtkMRMLFolderDisplayNode'))
        ...
        for index in range(allItems.GetNumberOfIds()):
            ...
            if self.shNode.IsItemLevel(currentItem, cjyx.vtkMRMLSubjectHierarchyConstants.GetSubjectHierarchyLevelFolder()):
    ...
    def TestSection_FolderVisibility(self):
        ...
        modelNodes = cjyx.util.getNodes('vtkMRMLModelNode*')
        ...
        testModelHierarchyVisibility = cjyx.vtkMRMLFolderDisplayNode.GetHierarchyVisibility(self.testModelNode)
        ...
        self.assertEqual(1, cjyx.mrmlScene.GetNumberOfNodesByClass('vtkMRMLFolderDisplayNode'))
    ...
    def TestSection_ApplyDisplayPropertiesOnBranch(self):
        ...
        testModelHierarchyOpacity = cjyx.vtkMRMLFolderDisplayNode.GetHierarchyOpacity(self.testModelNode)
