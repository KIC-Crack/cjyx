...
class SubjectHierarchyCorePluginsSelfTestTest(ScriptedLoadableModuleTest):
    ...
    def section_MarkupRole(self):
        ...
        markupsNode = cjyx.vtkMRMLMarkupsFiducialNode()
        cjyx.mrmlScene.AddNode(markupsNode)
    ...
    def section_CloneNode(self):
        ...
        markupsStorageNode = cjyx.vtkMRMLMarkupsFiducialStorageNode()
        cjyx.mrmlScene.AddNode(markupsStorageNode)
        ...
        self.assertEqual(cjyx.mrmlScene.GetNumberOfNodesByClass('vtkMRMLMarkupsFiducialNode'), 2)
        self.assertEqual(cjyx.mrmlScene.GetNumberOfNodesByClass('vtkMRMLMarkupsDisplayNode'), 2)
        self.assertEqual(cjyx.mrmlScene.GetNumberOfNodesByClass('vtkMRMLMarkupsFiducialStorageNode'), 2)
        ...
        inSameStudy = cjyx.vtkCjyxSubjectHierarchyModuleLogic.AreItemsInSameBranch(
            shNode, markupsShItemID, clonedMarkupsShItemID, cjyx.vtkMRMLSubjectHierarchyConstants.GetDICOMLevelStudy())
    ...
    def section_SegmentEditor(self):
        ...
        treeView = cjyx.util.findChildren(dataModuleWidget, className='qMRMLSubjectHierarchyTreeView')[0]
        ...
        segmentationNodes = cjyx.mrmlScene.GetNodesByClass('vtkMRMLSegmentationNode')
