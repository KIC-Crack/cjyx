...
//---------------------------------------------------------------------------
void vtkCjyxSegmentationsModuleLogic::SetMRMLSceneInternal(vtkMRMLScene* newScene)
{
...
//---------------------------------------------------------------------------
void vtkCjyxSegmentationsModuleLogic::OnMRMLSceneNodeAdded(vtkMRMLNode* node)
{
...
//-----------------------------------------------------------------------------
vtkMRMLSegmentationNode* vtkCjyxSegmentationsModuleLogic::GetSegmentationNodeForSegmentation(vtkMRMLScene* scene, vtkSegmentation* segmentation)
{
...
//-----------------------------------------------------------------------------
vtkMRMLSegmentationNode* vtkCjyxSegmentationsModuleLogic::GetSegmentationNodeForSegment(vtkMRMLScene* scene, vtkSegment* segment, std::string& segmentId)
{
  segmentId = "";
  if (!scene || !segment)
    {
...
//-----------------------------------------------------------------------------
vtkMRMLSegmentationNode* vtkCjyxSegmentationsModuleLogic::LoadSegmentationFromFile(const char* fileName,
...
//-----------------------------------------------------------------------------
vtkOrientedImageData* vtkCjyxSegmentationsModuleLogic::CreateOrientedImageDataFromVolumeNode(vtkMRMLScalarVolumeNode* volumeNode, vtkMRMLTransformNode* outputParentTransformNode /* = nullptr */)
{
...
//-----------------------------------------------------------------------------
int vtkCjyxSegmentationsModuleLogic::DoesLabelmapContainSingleLabel(vtkMRMLLabelMapVolumeNode* labelmapVolumeNode)
{
  if (!labelmapVolumeNode || !labelmapVolumeNode->GetImageData())
  {
    vtkGenericWarningMacro("vtkCjyxSegmentationsModuleLogic::DoesLabelmapContainSingleLabel: Invalid labelmap volume MRML node");
    return 0;
  }
...
//-----------------------------------------------------------------------------
vtkSegment* vtkCjyxSegmentationsModuleLogic::CreateSegmentFromLabelmapVolumeNode(vtkMRMLLabelMapVolumeNode* labelmapVolumeNode, vtkMRMLSegmentationNode* segmentationNode/*=nullptr*/)
{
  if (!labelmapVolumeNode)
    {
    vtkGenericWarningMacro("vtkCjyxSegmentationsModuleLogic::CreateSegmentFromLabelmapVolumeNode: Invalid labelmap volume MRML node");
    return nullptr;
    }
...
//-----------------------------------------------------------------------------
vtkSegment* vtkCjyxSegmentationsModuleLogic::CreateSegmentFromModelNode(vtkMRMLModelNode* modelNode, vtkMRMLSegmentationNode* segmentationNode/*=nullptr*/)
{
  if (!modelNode)
    {
    vtkGenericWarningMacro("vtkCjyxSegmentationsModuleLogic::CreateSegmentFromModelNode: Invalid model MRML node");
    return nullptr;
    }
...
//-----------------------------------------------------------------------------
vtkMRMLSegmentationNode* vtkCjyxSegmentationsModuleLogic::GetSegmentationNodeForSegmentSubjectHierarchyItem(
  vtkIdType segmentShItemID, vtkMRMLScene* scene )
{
  if (!scene)
    {
    vtkGenericWarningMacro("vtkCjyxSegmentationsModuleLogic::GetSegmentationNodeForSegmentSubjectHierarchyItem: Invalid MRML scene");
    return nullptr;
    }
...
//-----------------------------------------------------------------------------
vtkSegment* vtkCjyxSegmentationsModuleLogic::GetSegmentForSegmentSubjectHierarchyItem(vtkIdType segmentShItemID, vtkMRMLScene* scene)
{
  if (!scene)
    {
    vtkGenericWarningMacro("vtkCjyxSegmentationsModuleLogic::GetSegmentForSegmentSubjectHierarchyItem: Invalid MRML scene");
    return nullptr;
    }
  vtkMRMLSubjectHierarchyNode* shNode = vtkMRMLSubjectHierarchyNode::GetSubjectHierarchyNode(scene);
  if (!shNode)
...
//-----------------------------------------------------------------------------
bool vtkCjyxSegmentationsModuleLogic::ExportSegmentToRepresentationNode(vtkSegment* segment, vtkMRMLNode* representationNode)
{
  if (!segment)
    {
  ...
  vtkMRMLSegmentationNode* segmentationNode = vtkCjyxSegmentationsModuleLogic::GetSegmentationNodeForSegment(
...
//-----------------------------------------------------------------------------
bool vtkCjyxSegmentationsModuleLogic::ExportSegmentsToModels(vtkMRMLSegmentationNode* segmentationNode,
...
//-----------------------------------------------------------------------------
bool vtkCjyxSegmentationsModuleLogic::ExportVisibleSegmentsToModels(vtkMRMLSegmentationNode* segmentationNode, vtkIdType folderItemId)
{
  if (!segmentationNode)
    {
...
//-----------------------------------------------------------------------------
bool vtkCjyxSegmentationsModuleLogic::ExportAllSegmentsToModels(vtkMRMLSegmentationNode* segmentationNode, vtkIdType folderItemId)
{
...
//-----------------------------------------------------------------------------
void vtkCjyxSegmentationsModuleLogic::GenerateMergedLabelmapInReferenceGeometry(vtkMRMLSegmentationNode* segmentationNode,
...
//-----------------------------------------------------------------------------
bool vtkCjyxSegmentationsModuleLogic::ExportSegmentsToLabelmapNode(vtkMRMLSegmentationNode* segmentationNode,
...
//-----------------------------------------------------------------------------
bool vtkCjyxSegmentationsModuleLogic::ExportVisibleSegmentsToLabelmapNode(vtkMRMLSegmentationNode* segmentationNode,
...
//-----------------------------------------------------------------------------
bool vtkCjyxSegmentationsModuleLogic::ExportAllSegmentsToLabelmapNode(vtkMRMLSegmentationNode* segmentationNode, vtkMRMLLabelMapVolumeNode* labelmapNode,
  int extentComputationMode /*=vtkSegmentation::EXTENT_UNION_OF_EFFECTIVE_SEGMENTS*/)
{
  std::vector<std::string> segmentIDs;
...
//-----------------------------------------------------------------------------
bool vtkCjyxSegmentationsModuleLogic::ImportModelToSegmentationNode(vtkMRMLModelNode* modelNode,
...
//-----------------------------------------------------------------------------
bool vtkCjyxSegmentationsModuleLogic::ImportLabelmapToSegmentationNode(vtkMRMLLabelMapVolumeNode* labelmapNode,
  vtkMRMLSegmentationNode* segmentationNode, std::string insertBeforeSegmentId/*=""*/)
{
  if (!segmentationNode)
    {
...
//-----------------------------------------------------------------------------
bool vtkCjyxSegmentationsModuleLogic::ImportLabelmapToSegmentationNodeWithTerminology(vtkMRMLLabelMapVolumeNode* labelmapNode,
...
//-----------------------------------------------------------------------------
bool vtkCjyxSegmentationsModuleLogic::ApplyParentTransformToPolyData(vtkMRMLTransformableNode* transformableNode, vtkPolyData* polyData)
{
...
//-----------------------------------------------------------------------------
bool vtkCjyxSegmentationsModuleLogic::GetSegmentClosedSurfaceRepresentation(vtkMRMLSegmentationNode* segmentationNode,
...
//-----------------------------------------------------------------------------
bool vtkCjyxSegmentationsModuleLogic::SetTerminologyToSegmentationFromLabelmapNode(vtkMRMLSegmentationNode* segmentationNode,
...
//-----------------------------------------------------------------------------
void vtkCjyxSegmentationsModuleLogic::GetLabelValuesFromColorNode(vtkMRMLSegmentationNode* segmentationNode, vtkMRMLColorTableNode* colorTableNode,
...
//-----------------------------------------------------------------------------
vtkMRMLSegmentationNode* vtkCjyxSegmentationsModuleLogic::GetDefaultSegmentationNode()
{
...
//------------------------------------------------------------------------------
bool vtkCjyxSegmentationsModuleLogic::ClearSegment(vtkMRMLSegmentationNode* segmentationNode, std::string segmentId)
{
  if (!segmentationNode)
    {
...
//-----------------------------------------------------------------------------
bool vtkCjyxSegmentationsModuleLogic::ReconvertAllRepresentations(vtkMRMLSegmentationNode* segmentationNode,
...
//-----------------------------------------------------------------------------
void vtkCjyxSegmentationsModuleLogic::CollapseBinaryLabelmaps(vtkMRMLSegmentationNode* segmentationNode, bool forceToSingleLayer)
{
  if (!segmentationNode)
    {
    vtkErrorWithObjectMacro(nullptr, "Invalid segmentation node!");
