...
//----------------------------------------------------------------------------
bool qCjyxSubjectHierarchySegmentationsPlugin::addNodeToSubjectHierarchy(vtkMRMLNode* nodeToAdd, vtkIdType parentItemID)
{
...
{
  vtkMRMLSegmentationNode* segmentationNode = vtkCjyxSegmentationsModuleLogic::GetSegmentationNodeForSegmentSubjectHierarchyItem(
    qCjyxSubjectHierarchyPluginHandler::instance()->currentItem(), qCjyxSubjectHierarchyPluginHandler::instance()->mrmlScene());
  if (!segmentationNode)
    {
...
//---------------------------------------------------------------------------
void qCjyxSubjectHierarchySegmentationsPlugin::updateAllSegmentsFromMRML(vtkMRMLSegmentationNode* segmentationNode)
{
  // Get segmentation node
  if (!segmentationNode)
    {
...
//-----------------------------------------------------------------------------
bool qCjyxSubjectHierarchySegmentationsPlugin::showItemInView(vtkIdType itemID, vtkMRMLAbstractViewNode* viewNode, vtkIdList* allItemsToShow)
{
