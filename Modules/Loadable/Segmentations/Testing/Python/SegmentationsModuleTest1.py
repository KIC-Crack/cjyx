...
class SegmentationsModuleTest1(unittest.TestCase):
    ...
    def TestSection_LoadInputData(self):
        ...
        self.inputSegmentationNode = cjyx.util.getNode('vtkMRMLSegmentationNode1')
    ...
    def TestSection_MergeLabelmapWithDifferentGeometries(self):
        ...
        self.secondSegmentationNode = cjyx.mrmlScene.AddNewNodeByClass('vtkMRMLSegmentationNode', 'Second')
    ...
    def TestSection_ImportExportSegment(self):
        ...
        bodyModelNode = cjyx.vtkMRMLModelNode()
        bodyModelNode.SetName('BodyModel')
        cjyx.mrmlScene.AddNode(bodyModelNode)
        ...
        bodyLabelmapNode = cjyx.vtkMRMLLabelMapVolumeNode()
        bodyLabelmapNode.SetName('BodyLabelmap')
        cjyx.mrmlScene.AddNode(bodyLabelmapNode)
        ...
        allSegmentsLabelmapNode = cjyx.vtkMRMLLabelMapVolumeNode()
        allSegmentsLabelmapNode.SetName('AllSegmentsLabelmap')
        cjyx.mrmlScene.AddNode(allSegmentsLabelmapNode)
        ...
        modelImportSegmentationNode = cjyx.mrmlScene.AddNewNodeByClass('vtkMRMLSegmentationNode', 'ModelImport')
        ...
        multiLabelImportSegmentationNode = cjyx.mrmlScene.AddNewNodeByClass('vtkMRMLSegmentationNode', 'MultiLabelImport')
        ...
        singleLabelImportSegmentationNode = cjyx.mrmlScene.AddNewNodeByClass('vtkMRMLSegmentationNode', 'SingleLabelImport')
        ...
        bodyModelTransformNode = cjyx.vtkMRMLLinearTransformNode()
        cjyx.mrmlScene.AddNode(bodyModelTransformNode)
        ...
        bodyModelNodeTransformed = cjyx.vtkMRMLModelNode()
        bodyModelNodeTransformed.SetName('BodyModelTransformed')
        cjyx.mrmlScene.AddNode(bodyModelNodeTransformed)
        bodySegment = self.inputSegmentationNode.GetSegmentation().GetSegment(self.bodySegmentName)
        ...
        bodyLabelmapNodeTransformed = cjyx.vtkMRMLLabelMapVolumeNode()
        bodyLabelmapNodeTransformed.SetName('BodyLabelmapTransformed')
        cjyx.mrmlScene.AddNode(bodyLabelmapNodeTransformed)
        ...
        # Create transform node that will be used to transform the tested nodes
        modelTransformedImportSegmentationTransformNode = cjyx.vtkMRMLLinearTransformNode()
        cjyx.mrmlScene.AddNode(modelTransformedImportSegmentationTransformNode)
        ...
        modelTransformedImportSegmentationNode = cjyx.mrmlScene.AddNewNodeByClass('vtkMRMLSegmentationNode', 'ModelImportTransformed')
        ...
        cjyx.mrmlScene.RemoveNode(bodyModelNode)
        cjyx.mrmlScene.RemoveNode(bodyLabelmapNode)
        cjyx.mrmlScene.RemoveNode(allSegmentsLabelmapNode)
        cjyx.mrmlScene.RemoveNode(modelImportSegmentationNode)
        cjyx.mrmlScene.RemoveNode(multiLabelImportSegmentationNode)
        cjyx.mrmlScene.RemoveNode(singleLabelImportSegmentationNode)
        cjyx.mrmlScene.RemoveNode(bodyModelTransformNode)
        cjyx.mrmlScene.RemoveNode(bodyModelNodeTransformed)
        cjyx.mrmlScene.RemoveNode(bodyLabelmapNodeTransformed)
        cjyx.mrmlScene.RemoveNode(modelTransformedImportSegmentationNode)
    ...
    def TestSection_ImportExportSegment2(self):
        ...
        bodySegment = self.inputSegmentationNode.GetSegmentation().GetSegment(self.bodySegmentName)
        bodyLabelmapNode = cjyx.mrmlScene.AddNewNodeByClass('vtkMRMLLabelMapVolumeNode', 'BodyLabelmap')
        result = cjyx.vtkCjyxSegmentationsModuleLogic.ExportSegmentToRepresentationNode(bodySegment, bodyLabelmapNode)
        self.assertTrue(result)
        bodyImageData = bodyLabelmapNode.GetImageData()
        self.assertIsNotNone(bodyImageData)
        ...
        tumorLabelmapNode = cjyx.mrmlScene.AddNewNodeByClass('vtkMRMLLabelMapVolumeNode', 'TumorLabelmap')
        ...
        # Clean up temporary nodes
        cjyx.mrmlScene.RemoveNode(bodyLabelmapNode)
        cjyx.mrmlScene.RemoveNode(tumorLabelmapNode)
        cjyx.mrmlScene.RemoveNode(singleLabelImportSegmentationNode)
    ...
    def TestSection_SubjectHierarchy(self):
        ...
        # Remove segmentation
        cjyx.mrmlScene.RemoveNode(self.inputSegmentationNode)
