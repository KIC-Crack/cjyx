...
//-----------------------------------------------------------------------------
BrushPipeline* qCjyxSegmentEditorPaintEffectPrivate::brushForWidget(qMRMLWidget* viewWidget)
{
...
//-----------------------------------------------------------------------------
void qCjyxSegmentEditorPaintEffectPrivate::paintAddPoint(qMRMLWidget* viewWidget, double brushPosition_World[3],
...
//-----------------------------------------------------------------------------
void qCjyxSegmentEditorPaintEffectPrivate::updateBrushStencil(qMRMLWidget* viewWidget)
{
  Q_Q(qCjyxSegmentEditorPaintEffect);
  Q_UNUSED(viewWidget);
...
//-----------------------------------------------------------------------------
void qCjyxSegmentEditorPaintEffectPrivate::paintPixel(vtkOrientedImageData* modifierLabelmap, qMRMLWidget* viewWidget, double pixelPosition_World[3])
{
  Q_UNUSED(viewWidget);
...
//-----------------------------------------------------------------------------
void qCjyxSegmentEditorPaintEffectPrivate::updateBrushModel(qMRMLWidget* viewWidget, double brushPosition_World[3])
{
  Q_Q(qCjyxSegmentEditorPaintEffect);
...
//-----------------------------------------------------------------------------
void qCjyxSegmentEditorPaintEffectPrivate::updateBrush(qMRMLWidget* viewWidget, BrushPipeline* pipeline)
{
  Q_Q(qCjyxSegmentEditorPaintEffect);
...
//-----------------------------------------------------------------------------
std::string qCjyxSegmentEditorPaintEffectPrivate::segmentAtPosition(qMRMLWidget* viewWidget, double* ras)
{
  Q_Q(qCjyxSegmentEditorPaintEffect);
  if (!q->parameterSetNode())
    {
...
//---------------------------------------------------------------------------
bool qCjyxSegmentEditorPaintEffectPrivate::brushPositionInWorld(qMRMLWidget* viewWidget, int brushPositionInView[2], double brushPosition_World[3])
{
...
//-----------------------------------------------------------------------------
void qCjyxSegmentEditorPaintEffect::setMRMLDefaults()
{
...
//-----------------------------------------------------------------------------
void qCjyxSegmentEditorPaintEffect::updateGUIFromMRML()
{
  Q_D(qCjyxSegmentEditorPaintEffect);
  if (!this->active())
    {
...
//-----------------------------------------------------------------------------
void qCjyxSegmentEditorPaintEffect::updateMRMLFromGUI()
{
  Q_D(qCjyxSegmentEditorPaintEffect);
...
//-----------------------------------------------------------------------------
void qCjyxSegmentEditorPaintEffect::paintApply(qMRMLWidget* viewWidget)
{
  Q_D(qCjyxSegmentEditorPaintEffect);
...
//-----------------------------------------------------------------------------
QList<int> qCjyxSegmentEditorPaintEffect::paintBrushesIntoLabelmap(vtkOrientedImageData* labelmap, qMRMLWidget* viewWidget)
{
  Q_D(qCjyxSegmentEditorPaintEffect);
