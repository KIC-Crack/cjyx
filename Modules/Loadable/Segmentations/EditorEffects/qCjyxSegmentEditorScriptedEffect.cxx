...
//-----------------------------------------------------------------------------
QCursor qCjyxSegmentEditorScriptedEffect::createCursor(qMRMLWidget* viewWidget)
{
  Q_D(const qCjyxSegmentEditorScriptedEffect);
...
//-----------------------------------------------------------------------------
bool qCjyxSegmentEditorScriptedEffect::processInteractionEvents(vtkRenderWindowInteractor* callerInteractor, unsigned long eid, qMRMLWidget* viewWidget)
{
  Q_D(const qCjyxSegmentEditorScriptedEffect);
...
//-----------------------------------------------------------------------------
void qCjyxSegmentEditorScriptedEffect::processViewNodeEvents(vtkMRMLAbstractViewNode* callerViewNode, unsigned long eid, qMRMLWidget* viewWidget)
{
  Q_D(const qCjyxSegmentEditorScriptedEffect);
  PyObject* arguments = PyTuple_New(3);
...
//-----------------------------------------------------------------------------
void qCjyxSegmentEditorScriptedEffect::setMRMLDefaults()
{
  // Base class implementation needs to be called before the effect-specific one
...
//-----------------------------------------------------------------------------
void qCjyxSegmentEditorScriptedEffect::interactionNodeModified(vtkMRMLInteractionNode* interactionNode)
{
...
//-----------------------------------------------------------------------------
void qCjyxSegmentEditorScriptedEffect::updateGUIFromMRML()
{
  if (!this->active())
  {
...
//-----------------------------------------------------------------------------
void qCjyxSegmentEditorScriptedEffect::updateMRMLFromGUI()
{
  // Base class implementation needs to be called before the effect-specific one
  // Note: Left here as comment in case this class is used as template for adaptor
  //  classes of effect base classes that have default implementation of this method
