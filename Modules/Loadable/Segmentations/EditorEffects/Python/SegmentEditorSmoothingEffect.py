...
If segments overlap, segment higher in the segments table will have priority. <b>Applied to all visible segments.</b></li>
    ...
    def setupOptionsFrame(self):
        ...
        self.kernelSizeMMSpinBox = cjyx.qMRMLSpinBox()
        self.kernelSizeMMSpinBox.setMRMLScene(cjyx.mrmlScene)
        ...
        self.gaussianStandardDeviationMMSpinBox = cjyx.qMRMLSpinBox()
        self.gaussianStandardDeviationMMSpinBox.setMRMLScene(cjyx.mrmlScene)
    ...
    def smoothMultipleSegments(self, maskImage=None, maskExtent=None):
        ...
        self.scriptedEffect.parameterSetNode().SetOverwriteMode(cjyx.vtkMRMLSegmentEditorNode.OverwriteVisibleSegments)
        for segmentId, labelValue in segmentLabelValues:
