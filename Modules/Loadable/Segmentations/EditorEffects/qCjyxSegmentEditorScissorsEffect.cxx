...
//-----------------------------------------------------------------------------
ScissorsPipeline* qCjyxSegmentEditorScissorsEffectPrivate::scissorsPipelineForWidget(qMRMLWidget* viewWidget)
{
  Q_Q(qCjyxSegmentEditorScissorsEffect);
...
//-----------------------------------------------------------------------------
bool qCjyxSegmentEditorScissorsEffectPrivate::updateBrushModel(qMRMLWidget* viewWidget)
{
  Q_Q(qCjyxSegmentEditorScissorsEffect);
  ...
  if (sliceWidget)
    {
    vtkMRMLSliceNode* sliceNode = vtkMRMLSliceNode::SafeDownCast(qCjyxSegmentEditorAbstractEffect::viewNode(sliceWidget));
    if (!sliceNode)
      {
...
//-----------------------------------------------------------------------------
bool qCjyxSegmentEditorScissorsEffectPrivate::updateBrushStencil(qMRMLWidget* viewWidget)
{
  Q_Q(qCjyxSegmentEditorScissorsEffect);
  Q_UNUSED(viewWidget);
...
//-----------------------------------------------------------------------------
void qCjyxSegmentEditorScissorsEffectPrivate::paintApply(qMRMLWidget* viewWidget)
{
  Q_Q(qCjyxSegmentEditorScissorsEffect);
...
//-----------------------------------------------------------------------------
void qCjyxSegmentEditorScissorsEffect::setMRMLDefaults()
{
  Q_D(qCjyxSegmentEditorScissorsEffect);
...
//-----------------------------------------------------------------------------
void qCjyxSegmentEditorScissorsEffect::updateGUIFromMRML()
{
  Q_D(qCjyxSegmentEditorScissorsEffect);
...
//-----------------------------------------------------------------------------
void qCjyxSegmentEditorScissorsEffect::updateMRMLFromGUI()
{
  Q_D(qCjyxSegmentEditorScissorsEffect);
