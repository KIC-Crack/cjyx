...
class EndoscopyWidget(ScriptedLoadableModuleWidget):
    ...
    def setup(self):
        ...
        cameraNodeSelector = cjyx.qMRMLNodeComboBox()
        ...
        inputFiducialsNodeSelector = cjyx.qMRMLNodeComboBox()
        ...
        outputPathNodeSelector = cjyx.qMRMLNodeComboBox()
        ...
        cameraNodeSelector.setMRMLScene(cjyx.mrmlScene)
        inputFiducialsNodeSelector.setMRMLScene(cjyx.mrmlScene)
        outputPathNodeSelector.setMRMLScene(cjyx.mrmlScene)
...
class EndoscopyComputePath:
    ...
    def __init__(self, fiducialListNode, dl=0.5):
        ...
        if (self.fids.GetClassName() == "vtkMRMLMarkupsCurveNode"
            ...
            cjyx.vtkMRMLMarkupsCurveNode.ResamplePoints(self.fids.GetCurvePointsWorld(), resampledPoints, self.dl, self.fids.GetCurveClosed())
