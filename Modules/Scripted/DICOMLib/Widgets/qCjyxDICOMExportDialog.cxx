...
//-----------------------------------------------------------------------------
bool qCjyxDICOMExportDialog::exec(vtkIdType itemToSelect/*=vtkMRMLSubjectHierarchyNode::INVALID_ITEM_ID*/)
{
  Q_D(qCjyxDICOMExportDialog);
...
//-----------------------------------------------------------------------------
void qCjyxDICOMExportDialog::setMRMLScene(vtkMRMLScene* scene)
{
  Q_D(qCjyxDICOMExportDialog);
  d->Scene = scene;
}
