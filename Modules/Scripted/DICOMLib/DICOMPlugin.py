...
class DICOMPlugin:
    ...
    def addSeriesInSubjectHierarchy(self, loadable, dataNode):
        ...
        shn = cjyx.vtkMRMLSubjectHierarchyNode.GetSubjectHierarchyNode(cjyx.mrmlScene)
        ...
        shn.SetItemUID(seriesItemID, cjyx.vtkMRMLSubjectHierarchyConstants.GetDICOMUIDName(), seriesInstanceUid)
        shn.SetItemAttribute(seriesItemID, cjyx.vtkMRMLSubjectHierarchyConstants.GetDICOMSeriesModalityAttributeName(),
                             cjyx.dicomDatabase.fileValue(firstFile, tags['seriesModality']))
        shn.SetItemAttribute(seriesItemID, cjyx.vtkMRMLSubjectHierarchyConstants.GetDICOMSeriesNumberAttributeName(),
                             cjyx.dicomDatabase.fileValue(firstFile, tags['seriesNumber']))
        shn.SetItemAttribute(seriesItemID, cjyx.vtkMRMLSubjectHierarchyConstants.GetDICOMFrameOfReferenceUIDAttributeName(),
        ...
        shn.SetItemUID(seriesItemID, cjyx.vtkMRMLSubjectHierarchyConstants.GetDICOMInstanceUIDName(), instanceUIDs)
        ...
        shn.SetItemAttribute(seriesItemID, cjyx.vtkMRMLSubjectHierarchyConstants.GetDICOMReferencedInstanceUIDsAttributeName(),
                             referencedInstanceUIDs)
        ...
        patientItemID = shn.GetItemByUID(cjyx.vtkMRMLSubjectHierarchyConstants.GetDICOMUIDName(), patientId)
        studyId = cjyx.dicomDatabase.fileValue(firstFile, tags['studyID'])
        studyItemID = shn.GetItemByUID(cjyx.vtkMRMLSubjectHierarchyConstants.GetDICOMUIDName(), studyInstanceUid)
        ...
        if not patientItemID:
            ...
            if patientItemID:
                ...
                shn.SetItemAttribute(patientItemID, cjyx.vtkMRMLSubjectHierarchyConstants.GetDICOMPatientNameAttributeName(),
                                     patientName)
                shn.SetItemAttribute(patientItemID, cjyx.vtkMRMLSubjectHierarchyConstants.GetDICOMPatientIDAttributeName(),
                                     patientId)
                shn.SetItemAttribute(patientItemID, cjyx.vtkMRMLSubjectHierarchyConstants.GetDICOMPatientSexAttributeName(),
                ...
                shn.SetItemAttribute(patientItemID, cjyx.vtkMRMLSubjectHierarchyConstants.GetDICOMPatientBirthDateAttributeName(),
                                     patientBirthDate)
                shn.SetItemAttribute(patientItemID, cjyx.vtkMRMLSubjectHierarchyConstants.GetDICOMPatientCommentsAttributeName(),
        ...
        if not studyItemID:
            ...
            if studyItemID:
                ...
                shn.SetItemAttribute(studyItemID, cjyx.vtkMRMLSubjectHierarchyConstants.GetDICOMStudyDescriptionAttributeName(),
                                     studyDescription)
                studyDate = cjyx.dicomDatabase.fileValue(firstFile, tags['studyDate'])
                shn.SetItemAttribute(studyItemID, cjyx.vtkMRMLSubjectHierarchyConstants.GetDICOMStudyInstanceUIDAttributeName(),
                                     studyInstanceUid)
                shn.SetItemAttribute(studyItemID, cjyx.vtkMRMLSubjectHierarchyConstants.GetDICOMStudyIDAttributeName(),
                                     studyId)
                shn.SetItemAttribute(studyItemID, cjyx.vtkMRMLSubjectHierarchyConstants.GetDICOMStudyDateAttributeName(),
                                     studyDate)
                shn.SetItemAttribute(studyItemID, cjyx.vtkMRMLSubjectHierarchyConstants.GetDICOMStudyTimeAttributeName(),
