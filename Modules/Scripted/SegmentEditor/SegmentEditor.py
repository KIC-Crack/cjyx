...
class SegmentEditorWidget(ScriptedLoadableModuleWidget, VTKObservationMixin):
    ...
    def setup(self):
        ...
        self.editor = qCjyxSegmentationsModuleWidgetsPythonQt.qMRMLSegmentEditorWidget()
        ...
        self.editor.setMRMLScene(cjyx.mrmlScene)
        ...
        self.addObserver(cjyx.mrmlScene, cjyx.mrmlScene.StartCloseEvent, self.onSceneStartClose)
        self.addObserver(cjyx.mrmlScene, cjyx.mrmlScene.EndCloseEvent, self.onSceneEndClose)
        self.addObserver(cjyx.mrmlScene, cjyx.mrmlScene.EndImportEvent, self.onSceneEndImport)
    ...
    def selectParameterNode(self):
        ...
        segmentEditorNode = cjyx.mrmlScene.GetSingletonNode(segmentEditorSingletonTag, "vtkMRMLSegmentEditorNode")
        if segmentEditorNode is None:
            segmentEditorNode = cjyx.mrmlScene.CreateNodeByClass("vtkMRMLSegmentEditorNode")
            segmentEditorNode.UnRegister(None)
            segmentEditorNode.SetSingletonTag(segmentEditorSingletonTag)
            segmentEditorNode = cjyx.mrmlScene.AddNode(segmentEditorNode)
    ...
    def enter(self):
        ...
        if not self.editor.segmentationNodeID():
            segmentationNode = cjyx.mrmlScene.GetFirstNode(None, "vtkMRMLSegmentationNode")
