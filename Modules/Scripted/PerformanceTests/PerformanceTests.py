...
class PerformanceTestsWidget(ScriptedLoadableModuleWidget):
    ...
    def reslicing(self, iters=100):
        ...
        import math
        import numpy as np
        sliceNode = cjyx.util.getNode('vtkMRMLSliceNodeRed')
        ...
        resultTableName = cjyx.mrmlScene.GetUniqueNameByString("Reslice performance")
        resultTableNode = cjyx.mrmlScene.AddNewNodeByClass("vtkMRMLTableNode", resultTableName)
...
class sliceLogicTest:
    def __init__(self):
        self.step = 0
        self.sliceLogic = cjyx.vtkMRMLSliceLayerLogic()
        self.sliceLogic.SetMRMLScene(cjyx.mrmlScene)
        self.sliceNode = cjyx.vtkMRMLSliceNode()
        self.sliceNode.SetLayoutName("Black")
        cjyx.mrmlScene.AddNode(self.sliceNode)
