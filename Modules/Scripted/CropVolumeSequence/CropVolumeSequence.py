...
class CropVolumeSequenceWidget(ScriptedLoadableModuleWidget):
    ...
    def setup(self):
        ...
        #
        self.inputSelector = cjyx.qMRMLNodeComboBox()
        ...
        self.inputSelector.setMRMLScene(cjyx.mrmlScene)
        ...
        #
        self.outputSelector = cjyx.qMRMLNodeComboBox()
        ...
        self.outputSelector.setMRMLScene(cjyx.mrmlScene)
        ...
        #
        self.cropParametersSelector = cjyx.qMRMLNodeComboBox()
        ...
        self.cropParametersSelector.setMRMLScene(cjyx.mrmlScene)
    ...
    def onEditCropParameters(self):
        if not self.cropParametersSelector.currentNode():
            cropParametersNode = cjyx.mrmlScene.AddNewNodeByClass("vtkMRMLCropVolumeParametersNode")
...
class CropVolumeSequenceLogic(ScriptedLoadableModuleLogic):
    ...
    def run(self, inputVolSeq, outputVolSeq, cropParameters):
        ...
        seqBrowser = cjyx.mrmlScene.AddNewNodeByClass("vtkMRMLSequenceBrowserNode")
        ...
        if outputVolSeq:
            ...
            outputVolume = cjyx.mrmlScene.AddNewNodeByClass(inputVolume.GetClassName())
        ...
        try:
            ...
            if outputVolume:
                cjyx.mrmlScene.RemoveNode(outputVolume)
            # Temporary input browser node
            cjyx.mrmlScene.RemoveNode(seqBrowser)
            # Temporary input volume proxy node
            cjyx.mrmlScene.RemoveNode(inputVolume)
...
class CropVolumeSequenceTest(ScriptedLoadableModuleTest):
    ...
    def test_CropVolumeSequence1(self):
        ...
        croppedSequenceNode = cjyx.mrmlScene.AddNewNodeByClass('vtkMRMLSequenceNode')
        cropVolumeNode = cjyx.mrmlScene.AddNewNodeByClass('vtkMRMLCropVolumeParametersNode')
