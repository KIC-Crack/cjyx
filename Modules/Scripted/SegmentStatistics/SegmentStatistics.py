...
class SegmentStatisticsWidget(ScriptedLoadableModuleWidget):
    ...
    def setup(self):
        ...
        self.parameterNodeSelector = cjyx.qMRMLNodeComboBox()
        ...
        self.parameterNodeSelector.setMRMLScene(cjyx.mrmlScene)
        ...
        self.scalarSelector = cjyx.qMRMLNodeComboBox()
        ...
        self.scalarSelector.setMRMLScene(cjyx.mrmlScene)
        ...
        self.outputTableSelector = cjyx.qMRMLNodeComboBox()
        self.outputTableSelector.noneDisplay = "Create new table"
        self.outputTableSelector.setMRMLScene(cjyx.mrmlScene)
    ...
    def enter(self):
        ...
        if self.parameterNodeSelector.currentNode() is None:
            ...
            cjyx.mrmlScene.AddNode(parameterNode)
    ...
    def onApply(self):
        ...
        with cjyx.util.tryWithErrorDisplay("Failed to compute results.", waitCursor=True):
            if not self.outputTableSelector.currentNode():
                newTable = cjyx.mrmlScene.AddNewNodeByClass("vtkMRMLTableNode")
...
class SegmentStatisticsLogic(ScriptedLoadableModuleLogic):
    ...
    def computeStatistics(self):
        ...
        segmentationNode = cjyx.mrmlScene.GetNodeByID(self.getParameterNode().GetParameter("Segmentation"))
        ...
        try:
            if not segmentationNode.GetParentTransformNode() is None:
                ...
                transformedSegmentationNode = cjyx.vtkMRMLSegmentationNode()
                transformedSegmentationNode.Copy(segmentationNode)
                transformedSegmentationNode.HideFromEditorsOn()
                cjyx.mrmlScene.AddNode(transformedSegmentationNode)
            ...
            if transformedSegmentationNode is not None:
                ...
                cjyx.mrmlScene.RemoveNode(transformedSegmentationNode)
...
class SegmentStatisticsTest(ScriptedLoadableModuleTest):
    ...
    def test_SegmentStatisticsBasic(self):
        ...
        resultsTableNode = cjyx.vtkMRMLTableNode()
        cjyx.mrmlScene.AddNode(resultsTableNode)
