...
class ScalarVolumeSegmentStatisticsPlugin(SegmentStatisticsPluginBase):
    ...
    def computeStatistics(self, segmentID):
        ...
        grayscaleNode = cjyx.mrmlScene.GetNodeByID(self.getParameterNode().GetParameter("ScalarVolume"))
    ...
    def getStencilForVolume(self, segmentationNode, segmentID, grayscaleNode):
        ...
        cjyx.vtkMRMLTransformNode.GetTransformBetweenNodes(segmentationNode.GetParentTransformNode(),
    ...
    def getMeasurementInfo(self, key):
        ...
        scalarVolumeNode = cjyx.mrmlScene.GetNodeByID(self.getParameterNode().GetParameter("ScalarVolume"))
