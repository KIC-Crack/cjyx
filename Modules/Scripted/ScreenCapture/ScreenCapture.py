...
class ScreenCaptureWidget(ScriptedLoadableModuleWidget):
    ...
    def setup(self):
        ...
        # Input view selector
        self.viewNodeSelector = cjyx.qMRMLNodeComboBox()
        ...
        self.viewNodeSelector.setMRMLScene(cjyx.mrmlScene)
        ...
        self.sequenceBrowserNodeSelectorWidget = cjyx.qMRMLNodeComboBox()
        ...
        self.sequenceBrowserNodeSelectorWidget.setMRMLScene(cjyx.mrmlScene)
        ...
        self.volumeNodeComboBox = cjyx.qMRMLNodeComboBox()
        ...
        self.volumeNodeComboBox.setMRMLScene(cjyx.mrmlScene)
...
class ScreenCaptureLogic(ScriptedLoadableModuleLogic):
    ...
    def captureImageFromView(self, view, filename=None, transparentBackground=False, volumeNode=None):
        ...
        cjyx.app.processEvents()
        if view:
            if type(view) == cjyx.qMRMLSliceView or type(view) == cjyx.qMRMLThreeDView:
                view.forceRender()
            else:
                view.repaint()
        else:
        ...
        if volumeNode is not None:
            if isinstance(volumeNode, cjyx.vtkMRMLVectorVolumeNode):
...
class ScreenCaptureTest(ScriptedLoadableModuleTest):
    ...
    def setUp(self):
        ...
        layoutManager.setLayout(cjyx.vtkMRMLLayoutNode.CjyxLayoutFourUpView)
        for sliceViewNodeId in ['vtkMRMLSliceNodeRed', 'vtkMRMLSliceNodeYellow', 'vtkMRMLSliceNodeGreen']:
            cjyx.mrmlScene.GetNodeByID(sliceViewNodeId).SetSliceVisible(True)
    ...
    def test_SliceSweep(self):
        ...
        viewNode = cjyx.mrmlScene.GetNodeByID('vtkMRMLSliceNodeRed')
    ...
    def test_3dViewRotation(self):
        ...
        viewNode = cjyx.mrmlScene.GetNodeByID('vtkMRMLViewNode1')
        self.assertIsNotNone(viewNode)
    ...
    def test_VolumeNodeUpdate(self):
        ...
        volumeNode = cjyx.mrmlScene.AddNewNodeByClass("vtkMRMLVectorVolumeNode")
