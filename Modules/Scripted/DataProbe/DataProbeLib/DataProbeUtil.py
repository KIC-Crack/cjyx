...
class DataProbeUtil:
    ...
    def _findParameterNodeInScene(self):
        node = None
        size = cjyx.mrmlScene.GetNumberOfNodesByClass("vtkMRMLScriptedModuleNode")
        for i in range(size):
            n = cjyx.mrmlScene.GetNthNodeByClass(i, "vtkMRMLScriptedModuleNode")
    ...
    def _createParameterNode(self):
        ...
        """
        node = cjyx.vtkMRMLScriptedModuleNode()
