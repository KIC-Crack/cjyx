...
"""
    ...
    def performPostModuleDiscoveryTasks(self):
        ...
        if cjyx.mrmlScene.GetTagByClassName("vtkMRMLScriptedModuleNode") != 'ScriptedModule':
            cjyx.mrmlScene.RegisterNodeClass(vtkMRMLScriptedModuleNode())
        ...
        if not cjyx.app.commandOptions().noMainWindow:
            ...
            layoutNode.AddLayoutDescription(
                cjyx.vtkMRMLLayoutNode.CjyxLayoutDicomBrowserView, layout)
    ...
    def onLayoutChanged(self, viewArrangement):
        ...
        if (self.currentViewArrangement != cjyx.vtkMRMLLayoutNode.CjyxLayoutNone and
                self.currentViewArrangement != cjyx.vtkMRMLLayoutNode.CjyxLayoutDicomBrowserView):
        ...
        if self.currentViewArrangement == cjyx.vtkMRMLLayoutNode.CjyxLayoutDicomBrowserView:
    ...
    def onBrowserWidgetClosed(self):
        if (self.currentViewArrangement != cjyx.vtkMRMLLayoutNode.CjyxLayoutDicomBrowserView and
                self.currentViewArrangement != cjyx.vtkMRMLLayoutNode.CjyxLayoutNone):
        ...
        if (layoutId == cjyx.vtkMRMLLayoutNode.CjyxLayoutNone
                or layoutId == cjyx.vtkMRMLLayoutNode.CjyxLayoutDicomBrowserView):
            layoutId = qt.QSettings().value("MainWindow/layout", cjyx.vtkMRMLLayoutNode.CjyxLayoutInitialView)
...
class DICOMWidget(ScriptedLoadableModuleWidget):
    ...
    def setup(self):
        ...
        if layoutManager is not None:
            ...
            self.ui.showBrowserButton.checked = (viewArrangement == cjyx.vtkMRMLLayoutNode.CjyxLayoutDicomBrowserView)
        ...
        self.ui.subjectHierarchyTree.setMRMLScene(cjyx.mrmlScene)
    ...
    def onOpenBrowserWidget(self):
        cjyx.app.layoutManager().setLayout(cjyx.vtkMRMLLayoutNode.CjyxLayoutDicomBrowserView)
