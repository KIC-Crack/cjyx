...
class DICOMImageSequencePluginClass(DICOMPlugin):
    ...
    def addSequenceBrowserNode(self, name, outputSequenceNodes, playbackRateFps, loadable):
        ...
        outputSequenceBrowserNode = cjyx.vtkMRMLSequenceBrowserNode()
        outputSequenceBrowserNode.SetName(cjyx.mrmlScene.GenerateUniqueName(name + ' browser'))
        outputSequenceBrowserNode.SetPlaybackRateFps(playbackRateFps)
        cjyx.mrmlScene.AddNode(outputSequenceBrowserNode)
    ...
    def addSequenceFromImageData(self, imageData, tempFrameVolume, filePath, name, singleFileInLoadable):
        ...
        # Create new sequence
        outputSequenceNode = cjyx.mrmlScene.AddNewNodeByClass("vtkMRMLSequenceNode")
        ...
        outputSequenceStorageNode = cjyx.vtkMRMLVolumeSequenceStorageNode()
        cjyx.mrmlScene.AddNode(outputSequenceStorageNode)
    ...
    def load(self, loadable):
        ...
        if loadable.grayscale:
            tempFrameVolume = cjyx.mrmlScene.AddNewNodeByClass("vtkMRMLScalarVolumeNode")
        else:
            tempFrameVolume = cjyx.mrmlScene.AddNewNodeByClass("vtkMRMLVectorVolumeNode")
        ...
        cjyx.mrmlScene.RemoveNode(tempFrameVolume)
