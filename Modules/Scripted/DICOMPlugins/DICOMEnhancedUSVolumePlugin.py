...
class DICOMEnhancedUSVolumePluginClass(DICOMPlugin):
    ...
    def load(self, loadable):
        ...
        if loadable.grayscale:
            volumeNode = cjyx.mrmlScene.AddNewNodeByClass("vtkMRMLScalarVolumeNode", loadable.name)
        else:
            volumeNode = cjyx.mrmlScene.AddNewNodeByClass("vtkMRMLVectorVolumeNode", loadable.name)
